...
export default function App() {
  ...
  const [legalHubDefaultSection, setLegalHubDefaultSection] = useState<
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      triggerToast(
        language === "hi"
          ? "Google से सफलतापूर्वक लॉगिन किया गया!"
    ...
    if (authUser && matchedService) {
      ...
      try {
        ...
        handleFirestoreError(
          err,
          isCurrentlySaved ? OperationType.DELETE : OperationType.WRITE,
          path,
        );
      }
    }
    ...
    if ("Notification" in window) {
      window.Notification.requestPermission()
        ...
        .catch((err) => {
          ...
          triggerToast(
            language === "hi"
              ? "सिस्टम सूचना प्रणाली स्वीकृत!"
              : "System simulated notification approved!",
            "success",
          );
        });
    } else {
      ...
      triggerToast(
        language === "hi"
          ? "सिस्टम सूचना प्रणाली स्वीकृत (सिम्युलेटर मोड)!"
          : "System simulated notification approved (simulator mode)!",
        "success",
      );
    }
  };
  ...
  const handleSendFeedback = async (e: React.FormEvent) => {
    ...
    if (feedbackRating === 0) {
      triggerToast(
        language === "hi"
          ? "कृपया 1 से 5 स्टार रेटिंग चुनें।"
    ...
    <div className="min-h-screen bg-brand-cream-bg flex flex-col font-sans selection:bg-brand-coral selection:text-white pb-6 text-stone-900">
      ...
      <header className="hidden bg-gradient-to-b from-brand-cream-bg to-stone-50 border-b border-stone-200/85 shrink-0 relative shadow-xs">
        <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-3 sm:gap-4 flex-nowrap">
          ...
          <div
            className="hidden lg:flex items-center max-w-sm w-full gap-2 shrink-0"
          ...
          >
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder={
                  t("app.search_placeholder") || "Search a service (e.g. Aadhaar, PAN, Passport)"
                }
                value={searchQuery}
                onChange={(e) => {
                      ...
                      return (
                        ...
                        >
                          <span className="text-[10px] font-extrabold text-stone-900 dark:text-white leading-tight font-sans flex items-center justify-between">
                            ...
                            <span className="text-[8.5px] font-mono text-brand-coral opacity-80 shrink-0 font-bold ml-1.5">
                              Launch →
                            </span>
                          </span>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 ml-auto sm:ml-0 flex-nowrap py-1 relative min-w-0 max-w-full overflow-x-auto overscroll-x-contain scrollbar-none">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <motion.button
                ...
                className={`relative p-2 rounded-xl transition cursor-pointer select-none shrink-0 ${
                  activeTab === "services"
                    ? "text-brand-coral bg-orange-500/10 border border-brand-coral/20"
            ...
            <div
              className="hidden md:flex items-center gap-1 px-1.5 py-1 border border-stone-250 bg-stone-50/55 dark:bg-stone-900/60 rounded-full select-none shrink-0"
              id="header-quick-actions-row"
            >
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-0.5 text-[9.5px] sm:text-[10px] font-bold text-stone-700 hover:text-stone-950 dark:text-stone-300 dark:hover:text-white rounded-full transition border-0 bg-transparent cursor-pointer whitespace-nowrap"
                title={
                  language === "hi" ? "आवेदन की स्थिति जांचें" : "Track Citizen Application Status"
                }
              >
            ...
            <motion.button
              ...
              onClick={() => {
                ...
                triggerToast(
                  !darkMode
                    ? language === "hi"
                      ? "डार्क मोड सक्रिय (Low-light)"
                      : "High-Contrast Dark Mode enabled"
                    : language === "hi"
                      ? "लाइट मोड सक्रिय"
                      : "Standard Light Mode enabled",
                  "info",
                );
              }}
              ...
              title={
                darkMode ? "Switch to Light Mode" : "Switch to Dark Mode Suitable for Low-light"
              }
            ...
            >
              ...
              <div className="relative flex items-center gap-1 sm:gap-1.5 leading-none">
                ...
                <span>
                  ...
                  <span className="sm:hidden">{language === "hi" ? "आरंभ" : "Launch"}</span>
                </span>
          ...
          <div className="flex overflow-x-auto gap-1 -mb-px pt-1.5 scrollbar-none">
            ...
            >
              ...
              <span className="flex items-center gap-1">
                ...
                <span className="text-[8px] bg-[#FF5A2B]/10 text-[#FF5A2B] px-1 py-0.2 rounded font-mono">
                  NEW
                </span>
              </span>
            </button>
        ...
        <div className="max-w-7xl mx-auto flex items-center flex-wrap gap-2 text-[10.5px] sm:text-[11.5px] text-stone-500 dark:text-slate-400 font-sans tracking-wide">
          ...
          <button
            ...
            className={`flex items-center gap-1 transition uppercase font-bold ${
              (activeTab === "services" && !selectedService && !activeDossier) ||
          ...
          >
            <span>
              {activeTab === "services" &&
                (language === "hi" ? "सेवा निर्देशिका" : "Service Directory")}
              {activeTab === "eligibility" &&
                (language === "hi" ? "योग्यता और तुलना" : "Eligibility Tracker")}
              {activeTab === "lockers" && (language === "hi" ? "डिजिलॉकर" : "Citizen DigiLocker")}
              {activeTab === "chatbot" &&
                (language === "hi" ? "सेवामित्र AI" : "SewaMitra AI Helper")}
              {activeTab === "faq" &&
                (language === "hi" ? "सहायता और अक्सर पूछे जाने वाले प्रश्न" : "FAQs & Support")}
              {activeTab === "legal-hub" &&
                (language === "hi" ? "कानूनी और सुसंगति हब" : "Legal & Compliance Hub")}
              {activeTab === "sitemap" &&
                (language === "hi" ? "साइटमैप निर्देशिका" : "Portal Sitemap")}
              {activeTab === "discussions" &&
                (language === "hi" ? "सत्यापित नागरिक चर्चाएँ" : "Verified Citizen Discussions")}
            </span>
          </button>
            ...
            <>
              ...
              <span className="font-black text-stone-850 dark:text-stone-200 uppercase truncate max-w-[180px] sm:max-w-xs md:max-w-md">
                {(language === "hi" ? "आवेदन: " : "Apply: ") +
                  translateService(activeDossier).title}
              </span>
            </>
          )}
          ...
          {activeTab === "legal-hub" && legalHubDefaultSection && (
            <>
              ...
              <span className="font-black text-stone-850 dark:text-stone-200 uppercase">
                {legalHubDefaultSection === "about" &&
                  (language === "hi" ? "हमारे बारे में" : "About Us")}
                {legalHubDefaultSection === "privacy" &&
                  (language === "hi" ? "गोपनीयता नीति" : "Privacy Policy")}
                {legalHubDefaultSection === "terms" &&
                  (language === "hi" ? "सेवा की शर्तें" : "Terms & Conditions")}
                {legalHubDefaultSection === "cookies" &&
                  (language === "hi" ? "कुकी नीति" : "Cookie Policy")}
                {legalHubDefaultSection === "disclaimer" &&
                  (language === "hi" ? "अस्वीकरण" : "Disclaimer")}
                {legalHubDefaultSection === "rules" &&
                  (language === "hi" ? "नियम और विनियम" : "Rules & Regulations")}
              </span>
            </>
          )}
        </div>
      ...
      <div className="md:hidden fixed bottom-4.5 left-4 right-4 h-15 z-50 bg-white/95 dark:bg-slate-950/90 backdrop-blur-xl rounded-2xl border border-stone-200 dark:border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.12)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)] flex justify-between items-center gap-2 px-3 select-none sb-safe transition-all duration-300">
        ...
        <div className="relative flex-1 flex flex-col justify-center items-center h-full -mt-4.5 z-30">
          ...
          <span
            className={`text-[7.5px] uppercase tracking-wide leading-none font-black mt-1 ${
              activeTab === "chatbot"
        ...
        >
          {(isMobileMoreOpen ||
            ["eligibility", "sitemap", "faq", "legal-hub"].includes(activeTab)) && (
            <motion.div
              layoutId="mobileActiveIndicator"
              className="absolute inset-[3px] bg-stone-100 border border-stone-200/60 dark:bg-gradient-to-br dark:from-white/15 dark:to-white/5 dark:border-white/5 rounded-xl -z-10 shadow-3xs"
              transition={{ type: "spring", stiffness: 380, damping: 30 }}
                ...
                <div className="flex items-center justify-between pb-1 border-b border-stone-200 dark:border-white/5">
                  <div className="space-y-0.5 text-left">
                    ...
                    <p className="text-[9px] text-stone-500 dark:text-slate-400 font-sans">
                      {language === "hi"
                        ? "अतिरिक्त डिजिटल उपकरण और शिकायतें"
                        : "Access supplementary citizen portals"}
                    </p>
                  </div>
                  <button
                    onClick={() => setIsMobileMoreOpen(false)}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-1 w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div
          className={
            activeTab === "services" ? "lg:col-span-8 space-y-6" : "lg:col-span-12 space-y-6"
          }
        >
          {loading ? (
            <div className="p-20 text-center bg-white border border-gray-150 rounded-3xl flex flex-col items-center justify-center space-y-4">
              ...
              <p className="text-xs text-slate-500 font-mono">
                Securing encryption channels for e-Gov services gateway...
              </p>
            </div>
          ) : (
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-3.5 gap-y-2 text-stone-650 dark:text-slate-400 font-sans text-xs my-2 md:my-0">
            <button
              ...
              className="text-amber-600 dark:text-amber-500 hover:text-amber-400 dark:hover:text-amber-300 font-bold underline cursor-pointer transition"
            >
              🎯 FAQ Hub
            </button>
            ...
            <button
              ...
              className="text-emerald-600 dark:text-emerald-500 hover:text-emerald-400 dark:hover:text-emerald-300 font-bold underline cursor-pointer transition"
            >
              ⭐ Feedback
            </button>
            <span className="text-stone-300 dark:text-slate-700">|</span>
            ...
            <a
              href="/cookies"
              className="hover:text-stone-900 dark:hover:text-white underline cursor-pointer transition font-semibold"
            >
              Cookie Policy
            </a>
            <span className="text-stone-300 dark:text-slate-700">|</span>
            ...
            <a
              href="/disclaimer"
              className="hover:text-stone-900 dark:hover:text-white underline cursor-pointer transition font-semibold text-red-650 dark:text-red-400"
            >
              Disclaimer
            </a>
            <span className="text-stone-300 dark:text-slate-700">|</span>
            ...
            <div className="hidden md:flex bg-stone-900 text-white p-6 md:w-80 shrink-0 flex-col justify-between border-r border-stone-800 relative">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-black text-sm tracking-tight text-white leading-none">
                      SewaNadu Launcher
                    </h3>
                    <p className="text-[10px] text-stone-450 tracking-wider font-mono uppercase mt-1">
                ...
                <div className="space-y-3.5 pt-4">
                  <p className="text-[10px] font-mono uppercase text-slate-400 border-b border-stone-800 pb-1">
              ...
              <div className="pt-6 space-y-3">
                <div className="p-3 bg-stone-950 rounded-2xl border border-stone-800/60 text-[10.5px] text-stone-450 leading-normal font-sans">
                  Use this launchpad to instantly switch views, verify system compliance, and access
                  standard document re-issuances in your local native script.
                </div>
              ...
              <div>
                ...
                <div className="flex md:hidden items-center justify-between gap-3 mb-4 pb-3 border-b border-stone-150">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="font-display font-black text-xs tracking-tight text-stone-900 leading-none">
                        SewaNadu Launcher
                      </h3>
                      <p className="text-[8px] text-stone-450 tracking-wider font-mono uppercase mt-0.5">
                        National Command Hub
                      </p>
                    </div>
                  </div>
                              ...
                              return (
                                ...
                                >
                                  <span className="text-[10px] font-extrabold text-stone-900 leading-tight font-sans flex items-center justify-between">
                                    <span>{sTrans.title}</span>
                                    <span className="text-[8.5px] font-mono text-brand-coral shrink-0 font-bold ml-1.5">
                                      Launch →
                                    </span>
                                  </span>
                ...
                <h4 className="text-[11px] font-mono text-stone-500 uppercase tracking-widest font-bold mb-3">
                  Jump To Feature
                </h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-bold text-xs text-stone-850 font-sans">
                        All Citizen Services
                      </h5>
                      <p className="text-[10px] text-stone-500 leading-snug mt-0.5">
                        Apply for identity/welfare schemes
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-stone-500 leading-snug mt-0.5">
                        Determine fitment for DBT subventions
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-bold text-xs text-stone-850 font-sans">
                        Suvidha AI Assistant
                      </h5>
                      <p className="text-[10px] text-stone-500 leading-snug mt-0.5">
                        Discuss state criteria in natural language
                      </p>
                    </div>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      setActiveDossier(null);
                      triggerToast(
                        "Opening National Support & Welfare Contribution Gateway...",
                        "info",
                      );
                      setTimeout(() => {
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-bold text-xs text-[#FF5A2B] font-sans flex items-center gap-1">
                        ...
                        <span className="text-[7.5px] font-mono bg-red-100 text-red-700 px-1 py-0.2 rounded font-extrabold uppercase">
                          Patron
                        </span>
                      </h5>
                      <p className="text-[10px] text-stone-500 leading-snug mt-0.5">
                        Fund server uptime & rural offline digitization labs
                      </p>
                    </div>
                  </button>
                </div>
                ...
                <h4 className="text-[11px] font-mono text-stone-500 uppercase tracking-widest font-bold mb-2.5">
                  Switch Language Natively ({INDIAN_LANGUAGES.length} Indian States)
                </h4>
              ...
              <div className="pt-6 border-t border-stone-150/80 flex flex-wrap items-center justify-between text-[10.5px] text-stone-450 gap-2">
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => {
                      setActiveTab("legal-hub");
                      setLegalHubDefaultSection("privacy");
                      setShowLauncher(false);
                    }}
                  ...
                  <button
                    onClick={() => {
                      setActiveTab("legal-hub");
                      setLegalHubDefaultSection("terms");
                      setShowLauncher(false);
                    }}
                    className="hover:text-stone-700 underline cursor-pointer"
                  >
                  ...
                  <button
                    onClick={() => {
                      setActiveTab("legal-hub");
                      setLegalHubDefaultSection("rules");
                      setShowLauncher(false);
                    }}
                    className="hover:text-stone-700 underline cursor-pointer"
                  >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-3xl shadow-2xl border border-stone-200 w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div className="bg-stone-50 px-6 py-4 border-b border-stone-200 flex items-center justify-between relative">
              ...
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-display font-bold text-sm text-stone-900">
                  {policyModal === "privacy" &&
                    "SewaNadu National Privacy Standard & AdSense Disclosure"}
            ...
            <div className="p-6 overflow-y-auto space-y-4 text-xs font-sans text-stone-650 leading-relaxed max-h-[60vh]">
                ...
                <>
                  <div className="p-3 bg-blue-50/70 border border-blue-150 rounded-2xl text-blue-800 space-y-1.5 leading-normal">
                    ...
                    <p className="text-[11px] font-normal">
                      This portal uses Google AdSense automated advertising algorithms. To
                      understand cookies usage and DoubleClick programmatic tracking, please review
                      the compliance details below.
                    </p>
                  </div>

                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    1. Information We Collect
                  </h4>
                  <p>
                    SewaNadu operates on a 100% server-side sandbox and client-only state
                    persistence structure. We do not aggregate, harvest, or transmit personally
                    identifiable information (PII) including Aadhaar IDs, PAN credential names, or
                    grievance statements to third-party endpoints. All administrative forms you
                    complete here remain safely localized to your current browser memory sandbox.
                  </p>

                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    2. Google AdSense Cookie Requirements
                  </h4>
                  <p>
                    Our advertising monetization partners, including Google AdSense, utilize
                    third-party files called cookies to monitor visitor activity. Google's use of
                    advertising cookies enables it and its partners to serve targeted ads to users
                    based on their visit to SewaNadu and/or other sites on the Internet.
                  </p>
                  <p>
                    Specifically, Google employs the DoubleClick DART Tracking Cookie. Citizens may
                    choose to opt-out of the use of the DART cookie by visiting the official Google
                    Ad and Content Network Privacy Policy.
                  </p>

                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    3. Indian Data Protection Compliance
                  </h4>
                  <p>
                    This policy complies with standard Indian Ministry of Electronics AND
                    Information Technology (MeitY) directives and General Data Protection
                    regulations. For any inquiries regarding personal safety or credential
                    verification, please review our official contact support channels.
                  </p>
                </>
              )}
              ...
              {policyModal === "terms" && (
                <>
                  <p className="text-stone-500 italic pb-2">
                    Last Modified: June 13, 2026. Effective immediately in all states and union
                    territories.
                  </p>

                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    1. Permitted Public Utilization
                  </h4>
                  <p>
                    Welcome to SewaNadu. The e-Sewa gateway serves citizen subvention searches,
                    eligibility comparison metrics, and simulated government certificate tracking.
                    These items are produced for education, training, and direct general civic
                    welfare awareness. Usage of this portal for automated scanning or malicious data
                    crawling is strictly prohibited.
                  </p>

                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    2. Simulated Approvals Liability Disclaimer
                  </h4>
                  <p>
                    Administrative approvals (e.g., "SDO Revenue Officers Verification Signed")
                    completed via simulated triggers are educational and sandbox-confined.
                    Real-world e-Seva certificates, Aadhaar linking, and PM-AWAS subventions must be
                    lodged directly at physical Common Service Centers (CSC) in your respective
                    municipal district in accordance with sequential bureaucratic criteria.
                  </p>
                  ...
                  <p>
                    This portal lists state subventions, sub-category ratios, and estimated
                    processing timelines. Although we update criteria to match state gazettes,
                    real-time rates may vary. Citizens should check state gazettes before allocating
                    capital based on compare/eligibility calculators.
                  </p>
                </>
              )}
                ...
                <>
                  <div className="p-3 bg-amber-50/70 border border-amber-150 rounded-2xl text-amber-850 space-y-1 font-normal">
                    ...
                    <p className="text-[11px]">
                      We value transparency. By navigating the Indian national gateway, you consent
                      to essential localStorage preferences and AdSense campaign cookies.
                    </p>
                  </div>

                  <h4 className="font-bold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    1. Essential Preference Cookies
                  </h4>
                  <p>
                    We use local memory variables including <strong>eseva_language</strong> to store
                    your chosen Indian script, allowing the portal to load your preferred language
                    context automatically on repeat visits.
                  </p>

                  <h4 className="font-bold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    2. Google AdSense Partner Cookies
                  </h4>
                  <p>
                    Google, as a third-party vendor, uses cookies to serve ads on SewaNadu. Google's
                    use of the DoubleClick DART cookie enables it and its partners to serve ads
                    based on your browser history on other internet domains.
                  </p>
                  <p>
                    You can manage your advertising preferences by checking the ad preferences panel
                    inside your Google Account setup screen.
                  </p>
                </>
              )}
              ...
              {policyModal === "about" && (
                <>
                  <h4 className="font-extrabold text-[13px] text-stone-850 pt-2 border-b border-stone-150 pb-1">
                    Connecting Citizens across 28 States and 8 Union Territories
                  </h4>
                  <p>
                    SewaNadu is India's leading unified citizen e-services directory simulation. Our
                    mission is to bridge the gap between state ministries and daily citizens by
                    presenting standard document pre-requisites, eligibility rules, and CPGRAMS
                    feedback desking in a clear, language-agnostic mobile-responsive layout.
                  </p>
                  <p>
                    By offering all 11 Indian languages, we promote universal data accessibility as
                    outlined by the Digital India framework. Thank you for utilizing the national
                    portal.
                  </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-stone-500 font-medium">
                    {language === "hi"
                      ? "त्वरित लोक कल्याणकारी योजनाएं"
                      : "Quick welfare scheme directory search"}
                  </p>
                </div>
                <button
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder={
                      language === "hi"
                        ? "प्रमाण-पत्र, यूआईडीएआई, आयुष्मान..."
                        : "Search Caste, Income, UIDAI..."
                    }
                    value={searchQuery}
                    onChange={(e) => {
                      setSearchQuery(e.target.value);
              ...
              {searchQuery.trim().length > 0 && getAutoSuggestions().length > 0 && (
                <div className="space-y-1 p-1 max-h-48 overflow-y-auto border border-stone-200/60 rounded-2xl bg-stone-50 select-none animate-fadeIn transition-all">
                  <p className="text-[8.5px] font-mono text-stone-450 uppercase tracking-wider font-extrabold px-2.5 py-1.5 bg-white border-b border-stone-150 rounded-t-xl sticky top-0 flex items-center justify-between">
                    ...
                    <span className="text-[7.5px] font-bold text-brand-coral opacity-80 uppercase font-mono">
                      Found {getAutoSuggestions().length}
                    </span>
                  </p>
      ...
      {showFeedbackModal && (
        <div
          className="fixed inset-0 bg-black/60 backdrop-blur-xs z-[99999] flex items-center justify-center p-4 animate-fadeIn"
          id="portal-feedback-modal"
        >
          <div className="bg-white rounded-3xl shadow-2xl border border-stone-200 w-full max-w-md overflow-hidden flex flex-col animate-scaleUp">
            ...
            <div className="bg-stone-50 px-6 py-4 border-b border-stone-200 flex items-center justify-between relative">
              ...
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-display font-bold text-sm text-stone-900">
                  {feedbackService
                    ? language === "hi"
                      ? `${feedbackService.title} फ़ीडबैक`
                      : `Feedback: ${feedbackService.title}`
                    : language === "hi"
                      ? "SewaNadu पोर्टल फ़ीडबैक"
                      : "SewaNadu Portal Feedback"}
                </h3>
              </div>
            ...
            <form
              ...
              className="p-6 space-y-4 text-xs font-sans text-stone-650 leading-relaxed"
            >
              <div className="text-center space-y-2">
                <h4 className="font-bold text-sm text-stone-800">
                  {feedbackService
                    ? language === "hi"
                      ? `इस योजना के लिए आपका अनुभव कैसा रहा?`
                      : `How was your experience checking this service?`
                    : language === "hi"
                      ? "इस पोर्टल पर आपका अनुभव कैसा रहा?"
                      : "How was your experience using our digital gateway?"}
                </h4>
                <p className="text-[11px] text-stone-500">
                  {feedbackService
                    ? language === "hi"
                      ? "आपकी प्रतिक्रिया से हमें इस सेवा के दिशानिर्देशों को और स्पष्ट करने में सहायता मिलेगी।"
                      : "Your rating helps us ensure the checklist and guidelines for this document remain accurate."
                    : language === "hi"
                      ? "आपकी प्रतिक्रिया से हमें इस राष्ट्रीय सुविधा को और बेहतर बनाने में मदद मिलेगी।"
                      : "Your rating helps us improve this national digital bridge for all citizens."}
                </p>
              </div>
              ...
              {feedbackRating > 0 && (
                <div className="text-center font-bold text-amber-650 text-[11px] font-mono select-none">
                  {feedbackRating === 1 &&
                    (language === "hi"
                      ? "1 तारा • सुधार की आवश्यकता है"
                      : "1 Star • Needs Improvements")}
                  {feedbackRating === 2 &&
                    (language === "hi" ? "2 तारे • निष्पक्ष" : "2 Stars • Fair")}
                  {feedbackRating === 3 &&
                    (language === "hi" ? "3 तारे • अच्छा" : "3 Stars • Good")}
                  {feedbackRating === 4 &&
                    (language === "hi" ? "4 तारे • बहुत अच्छा" : "4 Stars • Very Good")}
                  {feedbackRating === 5 &&
                    (language === "hi" ? "5 तारे • उत्कृष्ट सेवा" : "5 Stars • Excellent Utility")}
                </div>
              )}
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder={
                    language === "hi"
                      ? "सेवा, गति या संवर्द्धन के संबंध में अपने अनुभव साझा करें..."
                      : "Share thoughts on the speed, services, layout, or translation correctness..."
                  }
                ></textarea>
            ...
            <div className="bg-stone-50 px-6 py-4 border-b border-stone-200 flex items-center justify-between relative">
              ...
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-display font-bold text-sm text-stone-900 leading-tight">
                  {language === "hi" ? "त्रुटि रिपोर्ट: " : "Report Issue: "}
                  {reportService.title}
                </h3>
              </div>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                >
                  <option value="incorrect_info">
                    {language === "hi"
                      ? "गलत जानकारी / दस्तावेज सूची"
                      : "Incorrect required paperwork/guidelines"}
                  </option>
                  <option value="broken_link">
                    {language === "hi"
                      ? "टूटी हुई लिंक / अमान्य पुनर्निर्देशन"
                      : "Broken redirection link"}
                  </option>
                  <option value="outdated_fees">
                    {language === "hi" ? "पुरानी या गलत सरकारी फीस" : "Outdated processing fees"}
                  </option>
                  <option value="wrong_department">
                    {language === "hi"
                      ? "गलत सरकारी विभाग / विभाग संबद्धता"
                      : "Inaccurate government department"}
                  </option>
                  <option value="other">
                    {language === "hi"
                      ? "अन्य तकनीकी / विवरण त्रुटियां"
                      : "Other layout or detail errors"}
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1">
                ...
                <span className="text-[9px] text-stone-400 block font-mono select-none font-sans">
                  {language === "hi"
                    ? "उपयोगी ताकि डेवलपर समस्या सुलझने पर आपसे संपर्क कर सकें"
                    : "Used to contact you once the issue is resolved by our developers"}
                </span>
              </div>
      ...
      >
        {activeSystemNotifications &&
          activeSystemNotifications.map((noti) => (
            <div
              key={noti.id}
