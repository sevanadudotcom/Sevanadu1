...
const SCHEMES_DATABASE: Scheme[] = [
  {
    ...
    requiredDocs: {
      en: [
        "Land ownership proof (Khatauni/Patta)",
        "Aadhaar Card copy",
        "Active Bank Passbook",
        "Mobile number linked with Aadhaar",
      ],
      hi: [
        "भूमि स्वामित्‍व प्रमाण (खतौनी/पट्टा)",
        "आधार कार्ड की प्रति",
        "सक्रिय बैंक पासबुक",
  ...
  },
  {
    ...
    requiredDocs: {
      en: [
        ...
        "Aadhaar Card",
        "Affidavit declaring no pucca house anywhere in India",
        "Address Proof",
      ],
      hi: [
        "आय प्रमाण पत्र / फॉर्म 16",
        "आधार कार्ड",
        "शपथ पत्र (कि भारत में कहीं भी पक्का घर नहीं है)",
        "पते का प्रमाण",
      ],
    },
  },
  {
    ...
    requiredDocs: {
      en: [
        "Cast Certificate issued by Tehsildar",
        "Gross Annual Income Certificate",
  ...
  },
  {
    ...
    requiredDocs: {
      en: [
        "e-Shram card / Registration details",
        "Aadhaar Card copy",
      ...
      hi: [
        ...
        "आधार कार्ड की प्रति",
        "ऑटो-डेबिट सहमति के साथ बचत बैंक खाता विवरण",
      ],
    },
  ...
  },
  {
    ...
    requiredDocs: {
      en: [
        ...
        "Parents' Income certificate (< ₹3 Lakh)",
        "Girl child Birth Certificate",
        "Aadhaar of Mother and Father",
      ],
      hi: [
        "उत्तर प्रदेश निवास प्रमाण पत्र",
        "माता-पिता का आय प्रमाण पत्र (< ₹3 लाख)",
  ...
  },
  {
    ...
    requiredDocs: {
      en: [
        "Rajasthan Domicile / Jan Aadhaar Card",
        "Ration Card copy",
        "BPL Status certificate (if applicable)",
        "Hospital birth certificate",
      ],
      hi: [
        "राजस्थान मूल निवास / जन आधार कार्ड",
        "राशन कार्ड की प्रति",
  ...
  },
  {
    ...
    requiredDocs: {
      en: [
        "Samagra ID code of family",
        "Madhya Pradesh Local Residence Certificate",
        "Active bank passbook copy with e-KYC linked",
      ],
      hi: [
        "परिवार की समग्र आईडी",
        "मध्य प्रदेश मूल निवास प्रमाण पत्र",
        "ई-केवाईसी लिंक्ड सक्रिय बैंक पासबुक की प्रति",
      ],
    },
  },
];
...
export default function EligibilityChecker({ onApplyForScheme }: EligibilityCheckerProps) {
  ...
  const categoriesList = ["All", "General", "OBC", "SC", "ST", "EWS"];
      ...
      if (hasSpecificState && state !== "All") {
        const matchesSpecificState = scheme.states.some(
          (s) =>
            ...
            (state === "Uttar Pradesh" && s === "UP") ||
            (state === "Madhya Pradesh" && s === "MP"),
        );
  ...
  return (
    <div
      className="bg-white border border-gray-150 rounded-2xl p-5 md:p-6 shadow-sm space-y-6 animate-fade-in"
      id="eligibility-checker-tool"
    >
      {/* Header section */}
      <div className="border-b border-gray-100 pb-4 space-y-1">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-extrabold text-slate-900 text-lg tracking-tight font-sans">
            {language === "hi"
              ? "स्मार्ट राष्ट्रीय पात्रता कैलकुलेटर"
              : "Smart National Eligibility Checker"}
          </h2>
        </div>
      ...
      {hasChecked && (
        <div
          className="space-y-4 pt-4 border-t border-dashed border-gray-250 animate-fade-in"
          ...
          {matchingSchemes.length === 0 ? (
            <div className="p-8 text-center rounded-2xl border border-dashed border-gray-200 bg-slate-50 text-slate-500 space-y-2">
              ...
              <p className="font-bold text-xs">
                {language === "hi" ? "कोई योजना मेल नहीं खाई" : "No Precise Match Found"}
              </p>
                ...
                >
                  <div className="space-y-2.5">
                    ...
                    <div className="p-3 bg-white border border-gray-150 rounded-xl flex items-start gap-2 text-xs">
                      ...
                      <div>
                        <strong className="text-emerald-700 block text-[10px] font-mono uppercase tracking-neutral-3">
                          {language === "hi"
                            ? "सरकारी लाभ वित्तीय सहायता"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {(language === "hi" ? scheme.requiredDocs.hi : scheme.requiredDocs.en).map(
                          (doc, dIdx) => (
                            <span
                              key={dIdx}
                              className="bg-slate-105 border border-gray-200 text-slate-650 px-2 py-0.8 rounded-lg text-[10px] uppercase font-bold tracking-tight"
                            >
                              {doc}
                            </span>
                          ),
                  ...
                  {scheme.associatedServiceId && (
                    <div className="pt-3 border-t border-dashed border-gray-200 flex items-center justify-between bg-white/40 -mx-4 -mb-4 p-3 rounded-b-2xl">
                      <span className="text-[10px] text-emerald-600 font-bold flex items-center gap-1">
                        ...
                        {language === "hi"
                          ? "इस पोर्टल पर तत्काल आवेदन खोलें!"
                          : "Directly Apply via Portal App"}
                      </span>
                      <button
                        type="button"
