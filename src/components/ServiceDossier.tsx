...
export default function ServiceDossier({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "documents" | "centers" | "support" | "procedure" | "form"
  >("overview");
  ...
  useEffect(() => {
    const handleOnline = () => {
      ...
      triggerToast(
        language === "hi"
          ? "कनेक्टिविटी बहाल! आप ऑनलाइन हैं।"
    ...
    const handleOffline = () => {
      ...
      triggerToast(
        language === "hi"
          ? "आप ऑफलाइन हैं। ऑफ़लाइन मोड सक्रिय।"
  ...
  const top3RelevantFaqs = useMemo(() => {
      ...
      return [
        {
          ...
          q: isHi
            ? "आधार विवरण (नाम, पता, जन्मतिथि या मोबाइल नंबर) सुधरने में कितना समय लगता है?"
            : "How long does an Aadhaar demographic or mobile update take?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या बायोमेट्रिक्स या मोबाइल नंबर लिंक कराने के लिए आधार केंद्र जाना अनिवार्य है?"
            : "Is physical center visit mandatory for biometrics or mobile linking?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या डाउनलोड किया गया ई-आधार या डिजीलॉकर कॉपी मूल कार्ड जितना ही मान्य है?"
            : "Is downloaded e-Aadhaar or DigiLocker copy legally equal to the physical card?",
          a: isHi
      ...
      return [
        {
          ...
          q: isHi
            ? "क्या एक से अधिक पैन (PAN) कार्ड रखना अवैध है और इस पर क्या जुर्माना है?"
            : "Is possessing more than one physical PAN card illegal and penalized?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "ई-पैन (Instant e-PAN) और प्लास्टिक पैन कार्ड में क्या अंतर है?"
            : "What is the difference between Instant e-PAN and physical PAN card?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "नया पैन कार्ड बनाने या पैन सुधार हेतु कौन सा मुख्य दस्तावेज अनिवार्य है?"
            : "What primary document is mandatory for a PAN application or correction?",
          a: isHi
      ...
      return [
        {
          ...
          q: isHi
            ? "तत्काल पासपोर्ट (Tatkal Passport) योजना में पुलिस सत्यापन कब किया जाता है?"
            : "When does police verification happen in the Tatkal Passport scheme?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "पासपोर्ट खो जाने या क्षतिग्रस्त होने की स्थिति में क्या तत्काल कदम उठाएं?"
            : "What is the mandatory procedure if a passport is lost or damaged?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या पुराने पासपोर्ट पर नया पता स्टिकर लगाकर बदला जा सकता है?"
            : "Can address be changed on an existing passport without re-issuing?",
          a: isHi
    ...
    if (
      ...
      sId.includes("residence") ||
      sId.includes("birth") ||
      sId.includes("death") ||
      sTitle.includes("caste") ||
      sTitle.includes("income") ||
      sTitle.includes("domicile")
    ) {
      return [
        {
          rank: "#1 Most Asked",
          ...
          q: isHi
            ? `इस प्रमाणपत्र (${service.title}) की वैधता अवधि कितनी होती है?`
            : `What is the validity period of this certificate (${service.title})?`,
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या एक नागरिक दो अलग-अलग राज्यों का मूल निवास/डोमिसाइल बनवा सकता है?"
            : "Can a citizen hold a Domicile or Residence certificate in two different states?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या प्रमाणपत्र जारी होने से पहले पटवारी या तहसीलदार द्वारा भौतिक सत्यापन होता है?"
            : "Does local revenue officer (Patwari/Tehsildar) verify details physically?",
          a: isHi
    ...
    if (
      ...
      sId.includes("dl") ||
      sId.includes("licence") ||
      sId.includes("vehicle") ||
      sTitle.includes("license") ||
      sTitle.includes("driving")
    ) {
      return [
        {
          rank: "#1 Most Asked",
          ...
          q: isHi
            ? "क्या एक आरटीओ द्वारा जारी ड्राइविंग लाइसेंस पूरे भारत में मान्य होता है?"
            : "Is a state RTO-issued driving license valid across all Indian states?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "यदि 6 महीने का लर्निंग लाइसेंस (Learner's License) समाप्त हो जाए तो क्या करें?"
            : "What happens if a 6-month Learner's License expires before the driving test?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "ड्राइविंग लाइसेंस नवीनीकरण हेतु मेडिकल फिटनेस सर्टिफिकेट (Form 1A) कब अनिवार्य है?"
            : "When is Medical Fitness Form 1A required for driving license renewal?",
          a: isHi
      ...
      return [
        {
          ...
          q: isHi
            ? "क्या 'वन नेशन वन राशन कार्ड' के तहत दूसरे राज्य में राशन लिया जा सकता है?"
            : "Can food grains be availed in another state under One Nation One Ration Card?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "क्या राशन कार्ड में परिवार की वरिष्ठ महिला को मुखिया बनाना अनिवार्य है?"
            : "Is the eldest female legally required to be the Head of Household on the ration card?",
          a: isHi
        ...
        },
        {
          ...
          q: isHi
            ? "राशन कार्ड में नए शिशु का नाम कैसे जोड़ें या शादी के बाद पुराना नाम कैसे हटाएं?"
            : "How do I add a newborn or remove a member post-marriage from a ration card?",
          a: isHi
    ...
    return [
      {
        ...
        q: isHi
          ? `आवेदन जमा करने के बाद ${service.title} की स्थिति कैसे ट्रैक करें?`
          : `How do I track the status of my application for ${service.title}?`,
        a: isHi
      ...
      },
      {
        ...
        q: isHi
          ? "क्या डिजीलॉकर (DigiLocker) के दस्तावेज़ इस आवेदन हेतु कानूनी रूप से मान्य हैं?"
          : "Are DigiLocker issued documents legally valid for this application?",
        a: isHi
      ...
      },
      {
        ...
        q: isHi
          ? `यदि निर्धारित ${service.processingTime} समय-सीमा में सेवा न मिले तो कहाँ अपील करें?`
          : `What recourse is available if processing exceeds the statutory ${service.processingTime} SLA?`,
        a: isHi
  ...
  const handleSaveToggleClick = (e: React.MouseEvent) => {
    ...
    triggerToast(
      isNowSaved
        ? language === "hi"
          ? `दस्तावेज़ "${service.title}" सफलतापूर्वक बुकमार्क किया गया!`
          : `"${service.title}" added to your saved list!`
        : language === "hi"
          ? `दस्तावेज़ "${service.title}" बुकमार्क से हटाया गया!`
          : `"${service.title}" removed from your saved list.`,
      "success",
    );
  };
  ...
  const copyToClipboard = (text: string) => {
    navigator.clipboard
      ...
      .catch(() => {
        triggerToast(language === "hi" ? "कॉपी करने में विफल!" : "Failed to copy link!", "error");
      });
    setShowShareMenu(false);
  };
  ...
  const meta = useMemo(() => {
    ...
    let agencyRole =
      "Nodal statutory body overseeing standard documentation under central electronic governance mandates.";
    ...
    let eligibilityConditions = [
      language === "hi"
        ? "आवेदक को भारत का वैध नागरिक या निवासी होना चाहिए।"
        : "Applicant must be a valid resident or citizen of India.",
      language === "hi"
        ? "दस्तावेज बनाने के लिए आवश्यक जन्म या पते का सहायक प्रमाण उपलब्ध हो।"
        : "Possession of basic support cert for DOB/Address checks.",
      language === "hi"
        ? "सभी सहायक संलग्नक डिजिटल नियमों (pdf, jpg < 2MB) के अनुकूल होने चाहिए।"
        : "Supporting uploads must meet digital scan standards (PDF/JPG < 2MB).",
    ];

    let updateDocuments = [
      language === "hi"
        ? "मूल पुराने सरकारी दस्तावेज/कार्ड की स्कैन कॉपी।"
        : "Scanned color copy of the original existing document/certificate.",
      language === "hi"
        ? "परिवर्तन का कानूनी प्रमाण (उदा. विवाह प्रमाण पत्र या राजपत्र अधिसूचना)।"
        : "Legal certificate confirming changed parameters (e.g., Marriage Certificate for name changes, Registered Lease/Registry for Address changes).",
      language === "hi"
        ? "आधार ई-केवाईसी या मोबाइल नंबर बायोमेट्रिक प्रमाणीकरण पर्ची।"
        : "Aadhaar e-KYC or official biometric authentication verified reference.",
      language === "hi"
        ? "पते/नाम सुधार हेतु स्व-घोषणा पत्र (अभिलेख संशोधन हेतु)।"
        : "Self-declaration affidavit confirming the veracity of revised fields.",
    ];
    ...
    let tatkalOption = {
      ...
      extraFee: 0,
      description:
        "Standard processing is expedited automatically under Public Services Guarantee Act SLAs.",
    };
    ...
    let faqs = [
      {
        q:
          language === "hi"
            ? "आवेदन जमा करने के बाद उसकी स्थिति कैसे ट्रैक करें?"
            : "How do I track the status of my application after submission?",
        a:
          language === "hi"
      ...
      },
      {
        q:
          language === "hi"
            ? "क्या डिजीलॉकर (DigiLocker) के दस्तावेज़ सत्यापन के लिए कानूनी रूप से मान्य हैं?"
            : "Are DigiLocker documents legally valid for verification?",
        a:
          language === "hi"
      ...
      },
      {
        q:
          language === "hi"
            ? "यदि मैं अपना संदर्भ संख्या (Reference Number) खो देता हूँ तो क्या होगा?"
            : "What happens if I lose my application reference number?",
        a:
          language === "hi"
    ...
    if (sId.includes("uidai") || sId.includes("aadhaar")) {
      ...
      agencyRole =
        "Statutory authority established under the Aadhaar Act, 2016 to issue unique 12-digit identities with individual biometric and demographic templates.";
      ...
      eligibilityConditions = [
        language === "hi"
          ? "भारत के सभी निवासी (नवजात शिशुओं सहित) आधार कार्ड के पात्र हैं।"
          : "Every individual residing in India (including infants/newborns) is eligible.",
        language === "hi"
          ? "अनिवासी भारतीय (NRI) भी आगमन पर वैध भारतीय पते के साथ पात्र हैं।"
          : "Non-Resident Indians (NRIs) hold absolute entitlement upon entry with local references.",
        language === "hi"
          ? "नामांकन के समय वास्तविक उंगलियों के निशान और आईरिस स्कैन (बायोमेट्रिक्स) अनिवार्य हैं।"
          : "Mandatory biometric capture (fingerprints & iris scans) at verified enrollment offices.",
      ];
      updateDocuments = [
        language === "hi"
          ? "बायोमेट्रिक अपडेट के लिए नागरिक की भौतिक उपस्थिति आवश्यक है।"
          : "Physical presence of resident at center is mandatory for biometric profile updates.",
        language === "hi"
          ? "नाम परिवर्तन हेतु मान्यता प्राप्त राजपत्र (Gazette Notification) दस्तावेज।"
          : "Sovereign Gazette notification proof for legal spelling or name corrections.",
        language === "hi"
          ? "पते में सुधार हेतु बिजली/पानी बिल, पासपोर्ट या पंजीकृत किराया विलेख आवश्यक है।"
          : "Certified utilities invoice, active Indian Passport or registered lease deed for address updates.",
      ];
      tatkalOption = {
        available: true,
        extraFee: 100,
        ...
        description:
          "Priority processing slot is allocated at UIDAI Aadhaar Seva Kendras for select urgent demographic modifications.",
      };
      faqs = [
        {
          q:
            language === "hi"
              ? "आधार सुधार अपडेट होने में कितना समय लगता है?"
              : "How long does an Aadhaar correction update take?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या बायोमेट्रिक और मोबाइल नंबर सुधार के लिए व्यक्तिगत उपस्थिति आवश्यक है?"
              : "Is physical presence required for biometrics or mobile verification?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या मैं अपना मोबाइल नंबर खुद ऑनलाइन अपडेट कर सकता हूँ?"
              : "Can I update my mobile number in Aadhaar online?",
          a:
            language === "hi"
      ...
      agencyRole =
        "National treasury authority responsible for direct tax operations, utilizing NSDL and UTITSL for issuing 10-character alphanumeric Permanent Account Numbers.";
      ...
      eligibilityConditions = [
        language === "hi"
          ? "सभी व्यक्तिगत करदाता, व्यवसाय, भागीदारी फर्में और हिंदू अविभाजित परिवार (HUF) पात्र हैं।"
          : "All corporate entities, legal Hindu Undivided Families (HUF), trusts and individual taxpayers.",
        language === "hi"
          ? "अल्पवयस्क (नाबालिग) माता-पिता के माध्यम से पैन कार्ड का आवेदन कर सकते हैं।"
          : "Minors are fully eligible through authorized application representation from guardians.",
        language === "hi"
          ? "आवेदक के पास आधार संख्या अनिवार्य रूप से होनी चाहिए।"
          : "Valid Aadhaar Number is strictly mandated for instant digital PAN e-KYC.",
      ];
      updateDocuments = [
        language === "hi"
          ? "विभिन्न विवाहों के उपरांत नाम बदलने हेतु विवाह पंजीकरण प्रमाण पत्र।"
          : "Certified Marriage registration credentials for surname changes post-marriage.",
        language === "hi"
          ? "नाम सुधार के नियम के तहत मूल विलेख की सत्यापित प्रति।"
          : "Deed Poll or sovereign gazette notification copy for substantial corrections.",
        language === "hi"
          ? "मोबाइल ओटीपी के मिलान द्वारा तत्काल डिजिलॉकर डेटा सत्यापन।"
          : "Instant digital validation of old fields via mobile OTP-linked DigiLocker dossier.",
      ];
      faqs = [
        {
          q:
            language === "hi"
              ? "क्या मैं दो पैन कार्ड या एक से अधिक पैन कार्ड रख सकता हूँ?"
              : "Can I hold multiple physical PAN cards legally?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "ई-पैन (e-PAN) और नॉर्मल भौतिक पैन कार्ड में क्या अंतर है?"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या पैन कार्ड बनवाने के लिए आधार कार्ड होना अनिवार्य है?"
              : "Is an Aadhaar Card mandatory for a PAN Card application?",
          a:
            language === "hi"
      ...
      agencyRole =
        "Federal regulatory authority managing international travel clearances, utilizing integrated Passport Seva Kendras (PSK) and Post Office Seva Kendras (POPSK).";
      ...
      eligibilityConditions = [
        language === "hi"
          ? "आवेदक अनिवार्य रूप से भारत संघ का संप्रभु नागरिक होना चाहिए।"
          : "Applicant must be a sovereign citizen of the Republic of India.",
        language === "hi"
          ? "आवेदक के विरुद्ध न्यायालय में कोई भी आपराधिक शिकायत लंबित या सक्रिय नहीं होनी चाहिए।"
          : "No pending criminal trials or active warrants on the applicant in any Indian court.",
        language === "hi"
          ? "पुलिस सत्यापन के समय वर्तमान पते पर निवास संबंधी न्यूनतम 1 वर्ष का साक्ष्य हो।"
          : "Min. 1-year residency trace proof at current location for external police verification.",
      ];
      updateDocuments = [
        language === "hi"
          ? "पुराने पासपोर्ट का मूल बुकलेट (Expired / Damaged Passport Booklet)।"
          : "Original physical expired or near-expiry passport booklet.",
        language === "hi"
          ? "पते के मिलान हेतु वर्तमान पते के साक्ष्य का नया राजपत्रित प्रमाण पत्र।"
          : "Primary address verification certificate matches reflecting the newly updated domicile.",
        language === "hi"
          ? "शैक्षणिक श्रेणी में परिवर्तन (Non-ECR status) हेतु मैट्रिक प्रमाणपत्र।"
          : "Matriculation / Graduation certificate for Non-ECR statutory category updates.",
      ];
      tatkalOption = {
        available: true,
        extraFee: 2000,
        ...
        description:
          "Tatkal Passport scheme permits accelerated production within 72 hours subject to clean central verification checks.",
      };
      faqs = [
        {
          q:
            language === "hi"
              ? "तत्काल पासपोर्ट (Tatkal Passport) योजना में पुलिस सत्यापन कब होता है?"
              : "When does police verification happen in the Tatkal scheme?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "पासपोर्ट के क्षतिग्रस्त होने या खो जाने पर क्या कार्रवाई करें?"
              : "What is the procedure for a damaged or lost passport?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या मैं अपने पुराने पासपोर्ट में ही नया पता बदलवा सकता हूँ?"
              : "Can I change my residential address on an existing passport?",
          a:
            language === "hi"
      ...
      agencyRole =
        "Authorized district revenue administration validating historical ancestral community descent records for social welfare representation.";
      website = isStateService
        ? `https://edistrict.${matchedState.id}.gov.in`
        : "https://india.gov.in";
      eligibilityConditions = [
        language === "hi"
          ? `आवेदक मूल रूप से ${regionName} का निवासी होना चाहिए।`
          : `Applicant must be an native citizen residing permanently in ${regionName}.`,
        language === "hi"
          ? "आवेदक के परिवार का नाम राज्य या केंद्रीय आरक्षित सूची (SC/ST/OBC) में शामिल हो।"
          : "Family lineage must be actively listed in the state or central Scheduled reservation lists.",
        language === "hi"
          ? "पिछड़ा वर्ग (OBC नॉन-क्रीमी लेयर) प्रमाणपत्र के लिए पारिवारिक आय की सीमा ₹8 लाख से कम हो।"
          : "Annual household income must be strictly below ₹8 Lakhs for OBC Non-Creamy Layer certificates.",
      ];
      ...
      agencyRole =
        "Statutory district authority verifying physical land holding yields, wage structures, and retail income parameters of residents.";
      website = isStateService
        ? `https://edistrict.${matchedState.id}.gov.in`
        : "https://india.gov.in";
      eligibilityConditions = [
        language === "hi"
          ? `आवेदक ${regionName} क्षेत्र में वर्तमान में निवास कर रहा हो।`
          : `Applicant must be an active resident within the territory boundaries of ${regionName}.`,
        language === "hi"
          ? "परिवार के आय के सभी स्रोतों (कृषि, व्यापार, वेतन, पेंशन) का कुल योग घोषित हो।"
          : "Declaration of all combined wage channels (agricultural, investments, salaries).",
        language === "hi"
          ? "आय सत्यापन हेतु स्थानीय पटवारी या राजस्व निरीक्षक की जांच रिपोर्ट आवश्यक है।"
          : "Local Patwari/Tehsildar physical site and asset inquiry clearance.",
      ];
    } else if (
      sId.includes("-domicile") ||
      sId.includes("residence") ||
      sId.includes("domicile-cert")
    ) {
      agencyName = isStateService
      ...
      agencyRole =
        "State regulatory body validating long-term continuous residence of a citizen within regional state borders.";
      website = isStateService
        ? `https://edistrict.${matchedState.id}.gov.in`
        : "https://india.gov.in";
      eligibilityConditions = [
        language === "hi"
          ? `आवेदक ${regionName} में न्यूनतम 15 वर्षों से लगातार रह रहा हो (या वहां पैदा हुआ हो)।`
          : `Applicant must have resided continuously in ${regionName} for at least 15 years (or is an active native born citizen).`,
        language === "hi"
          ? "आवेदक की अपनी भूमि संपत्ति हो या राज्य के स्थानीय विद्यालय से निरंतर 10वीं/12वीं तक पढ़ाई की हो।"
          : "Owns agricultural/residential property or finished Grade 10/12 exams from active regional schools.",
        language === "hi"
          ? "आवेदक का नाम स्थानीय राज्य मतदाता सूची (Voter List) में पंजीकृत हो।"
          : "Electoral enrollment in the local municipal voter guides is required.",
      ];
    } else if (
      sId.includes("rto") ||
      sId.includes("driving") ||
      ...
      agencyName =
        "Ministry of Road Transport and Highways (MoRTH) & Regional Transport Officer (RTO)";
      agencyRole =
        "State Transport Authority enforcing national driving fitness, motor licensing standards, and smart-card permit issuance under the Motor Vehicles Act, 1988.";
      ...
      eligibilityConditions = [
        language === "hi"
          ? "गियर रहित वाहनों के लिए आयु न्यूनतम 16 वर्ष और अन्य वाणिज्यिक/परिवहन वाहनों के लिए न्यूनतम 20 वर्ष हो।"
          : "Ages 16+ for gearless small engines, 18+ for normal gears, and 20+ for heavy commercial transport licences.",
        language === "hi"
          ? "स्थायी ड्राइविंग लाइसेंस के आवेदन से पूर्व वैध शिक्षार्थी (Learner's Licence) पहचान पत्र होना अनिवार्य है।"
          : "Possession of a valid Learner's Licence for at least 30 active days prior to driving test scheduling.",
        language === "hi"
          ? "आवेदक को आरटीओ परिसर में प्रायोगिक ड्राइविंग टेस्ट को अनिवार्य रूप से उत्तीर्ण करना होगा।"
          : "Must successfully clear the live computerized and on-road driving test under RTO guidance.",
      ];
      updateDocuments = [
        language === "hi"
          ? "मूल समाप्त होने जा रहा (Expired) ड्राइविंग लाइसेंस पत्रक।"
          : "Original expired or active smart-card driving licence copy.",
        language === "hi"
          ? "चिकित्सीय उपयुक्तता हेतु फॉर्म 1A फिटनेस सर्टिफिकेट (40 वर्ष से अधिक आयु वालों के लिए)।"
          : "Medical fitness certificate on Form 1A certified by matching govt panel doctor (Mandatory for ages 40+).",
        language === "hi"
          ? "नाम या पते में बदलाव हेतु राजपत्र या मतदाता पहचान पत्र प्रमाण।"
          : "Gazette of India, marriage details, or Aadhaar for name modifications.",
      ];
    } else if (sId.includes("voter") || sId.includes("eci")) {
      agencyName = "Election Commission of India (ECI)";
      agencyRole =
        "Sovereign constitutional authority superintendending, directing, and controlling national and state assembly elections, establishing voters database grids.";
      ...
      eligibilityConditions = [
        language === "hi"
          ? "आवेदक अनिवार्य रूप से भारत का नागरिक हो तथा आवेदन की तिथि तक आयु 18 वर्ष या अधिक हो।"
          : "Applicant must be an Indian citizen holding an age parameter of 18+ on the qualifying cohort date.",
        language === "hi"
          ? "आवेदक अपने घोषित सामान्य निवास के मतदान केंद्र में पंजीकरण का हकदार है।"
          : "Applicant is eligible to enroll only at their primary ordinary place of residence.",
        language === "hi"
          ? "आवेदक कानूनन मानसिक रूप से अस्वस्थ या आपराधिक गतिविधि के कारण मतदान से वंचित नहीं होना चाहिए।"
          : "No statutory voter exclusions under electoral laws due to criminal disqualifications.",
      ];
      updateDocuments = [
        language === "hi"
          ? "मूल वोटर आईडी कार्ड (EPIC Card) की प्रति।"
          : "Copy of original voter identity card (EPIC number references).",
        language === "hi"
          ? "नए विधानसभा क्षेत्र में स्थानांतरण की पुष्टि हेतु निवास का नया मूल प्रमाण।"
          : "Valid residential occupancy proof for constituency migration cases (Form 8 routing).",
        language === "hi"
          ? "स्वयं की रंगीन पासपोर्ट फोटो (सुधार एवं नए कार्ड मुद्रण हेतु)।"
          : "Recent raw colored high-definition passport passport photograph.",
      ];
      ...
      agencyRole =
        "Government nodal board mapping household economic parameters to distribute subsidized essential commodities under National Food Security Act codes.";
      website = isStateService
        ? `https://edistrict.${matchedState.id}.gov.in`
        : "https://nfsa.gov.in";
      eligibilityConditions = [
        language === "hi"
          ? "परिवार के मुख्य आवेदक के रूप में परिवार की सबसे वरिष्ठ महिला (18+) का विवरण अनिवार्य है।"
          : "The eldest female member of the family (aged 18+) must ideally be registered as the Head of Household.",
        language === "hi"
          ? "सभी सदस्यों के आधार कार्ड मोबाइल नंबर और व्यक्तिगत खातों से लिंक होने चाहिए।"
          : "Aadhaar Card copy of every member proposed on the ration lists is mandatory.",
        language === "hi"
          ? "आवेदक परिवार के पास राज्य के भीतर कोई अन्य राशन कार्ड पंजीकृत नहीं होना चाहिए (दोहरा नामांकन प्रतिबंधित)।"
          : "Strict prohibition of dual enrollment. No prior card must be active in another town/location.",
      ];
      updateDocuments = [
        language === "hi"
          ? "परिवार में जन्म लिए नए शिशु का जन्म प्रमाण पत्र (नया नाम जोड़ने हेतु)।"
          : "Newborn birth certificate issued by municipal ward authorities (for family member additions).",
        language === "hi"
          ? "महिला सदस्य के विवाह के उपरांत नाम हटाने हेतु डिलीशन सर्टिफिकेट या ट्रांसफर आर्डर।"
          : "Official community deletion certificate of spouse from previous state family list (for marriage migrations).",
        language === "hi"
          ? "अधिकार संशोधन पत्रक (नए सदस्यों के बायोमेट्रिक्स सहमति)।"
          : "Updated biometric sync reference and Aadhaar linking certificates on PDS database.",
      ];
    } else {
    ...
    if (
      sId.includes("-caste") ||
      sId.includes("caste-cert") ||
      sId.includes("-income") ||
      sId.includes("income-cert") ||
      sId.includes("-domicile") ||
      sId.includes("residence") ||
      sId.includes("domicile-cert")
    ) {
      faqs = [
        {
          q:
            language === "hi"
              ? "आय प्रमाणपत्र (Income Certificate) की वैधता अवधि कितनी होती है?"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या मैं एक साथ दो विभिन्न राज्यों के लिए मूल निवास प्रमाणपत्र बनवा सकता हूँ?"
              : "Can I apply for a Domicile Certificate in two different states?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या जाति प्रमाणपत्र (Caste Certificate) को समय-समय पर नवीनीकृत करना पड़ता है?"
              : "Does a Caste Certificate require periodic renewal?",
          a:
            language === "hi"
      ...
      faqs = [
        {
          q:
            language === "hi"
              ? "क्या राज्य द्वारा जारी ड्राइविंग लाइसेंस पूरे भारत में मान्य होता है?"
              : "Is a state-issued driving license valid all over India?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "स्थायी ड्राइविंग लाइसेंस (Permanent DL) की कुल वैधता कितनी होती है?"
              : "What is the physical validity of a permanent driving license?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "यदि लर्निंग लाइसेंस की अवधि ६ महीने समाप्त हो जाए तो क्या होगा?"
              : "What happens if my 6-month Learner's License expires?",
          a:
            language === "hi"
      ...
      faqs = [
        {
          q:
            language === "hi"
              ? "क्या परिवार के सदस्य का नाम एक ही समय पर दो अलग राशन कार्डों में हो सकता है?"
              : "Can a member be listed on two ration cards simultaneously?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या राशन कार्ड में परिवार का मुखिया केवल महिला सदस्य ही हो सकती है?"
              : "Is it mandatory for the head of household to be a woman?",
          a:
            language === "hi"
        ...
        },
        {
          q:
            language === "hi"
              ? "क्या मैं भारत के किसी भी राज्य में इस राशन कार्ड से अनाज ले सकता हूँ?"
              : "Can I procure food grains in other states under One Nation One Ration Card?",
          a:
            language === "hi"
    ...
    if (sId.includes("uidai") || sId.includes("aadhaar")) {
      ...
      externalLinks = [
        {
          label: "NSDL Online PAN Application",
          url: "https://www.onlineservices.nsdl.com/paam/endUserRegisterWithSSO.html",
        },
      ...
      externalLinks = [{ label: "Passport Seva Portal", url: "https://www.passportindia.gov.in" }];
    } else if (
      sId.includes("rto") ||
      sId.includes("driving") ||
      sId.includes("-dl") ||
      ...
      externalLinks = [{ label: "ECI Voters Service Portal", url: "https://voters.eci.gov.in" }];
    } else if (sId.includes("ration") || sId.includes("pds") || sId.includes("-ration")) {
      designatedOffice = {
      ...
      externalLinks = [{ label: "National Food Security Portal", url: "https://nfsa.gov.in" }];
      ...
      externalLinks = [{ label: "e-Shram Official Registration", url: "https://eshram.gov.in" }];
    }
    ...
    if (matchingWizardDoc) {
      ...
      if (isStateService && matchedState) {
        const stateHasAlready = mergedLinks.some(
          (l) =>
            l.label.toLowerCase().includes(matchedState.name.toLowerCase()) ||
            l.url.includes(matchedState.id),
        );
        if (!stateHasAlready) {
          mergedLinks.unshift({
            label: `${matchedState.name} e-District Portal`,
  ...
  const physicalCenters = useMemo(() => {
    ...
    const centerTypes = [
      ...
      {
        prefix: "CSC Citizen Center Portal",
        suffix: "Main Retail Market Complex, near Municipal Hub",
      },
      {
        prefix: "Lok Seva Hub & Tehsildar Office",
        suffix: "Sub-Divisional Magistrate Judicial Complex Office",
      },
    ];
    ...
    if (service.id.includes("uidai") || service.id.includes("aadhaar")) {
      return [
        {
          id: "c1",
          name: `Aadhaar Seva Kendra, District HQ`,
          address: `Sector-5, Civic Administration Center, near State Library, PIN-110011`,
          phone: "011-23091497",
        ...
        {
          id: "c2",
          name: `Aadhaar Enrollment Board, Post Office Branch`,
          address: `Main GPO, Court Road Colony, PIN-110091`,
          phone: "011-23485012",
        ...
        {
          id: "c3",
          name: `Aadhaar Center, SBI Regional Corporate Office`,
          address: `State Bank Circle, Main Commercial Complex, PIN-110022`,
          phone: "011-23910382",
    ...
    if (service.id.includes("passport")) {
      return [
        {
          id: "c1",
          name: `MEA Passport Seva Kendra (PSK)`,
          address: `Commercial Trade Tower, Block A-2, Metro Station Bypass Road, Capital City`,
          phone: "1800-258-1800",
        ...
        },
        {
          ...
          address: `Head Post Office Hub building reception desk, District HQ, Outer Circle`,
          phone: "011-23190823",
    ...
    const docContent = `
      ...
      <body>
        ...
        <div class="section">
          ...
          <ol class="step-list">
            ${(meta.stepByStep[language === "hi" ? "hi" : "en"] || meta.stepByStep.en)
              .map(
...
============================================================
      ...
      triggerToast(
        language === "hi"
          ? "दस्तावेज सूची सफलतापूर्वक सहेज ली गई है!"
          : "Citizen dossier checklist saved successfully!",
        "success",
      );
    }, 1200);
  };
  ...
  const selectedCenter =
    searchedCenters.find((c) => c.id === selectedCenterId) || searchedCenters[0];

  return (
    <div
      className="bg-white border border-stone-200 rounded-3xl overflow-hidden shadow-xs text-left"
      id={`dossier-page-${service.id}`}
    >
      {/* Banner Top Panel */}
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2" id="dossier-actions-group">
            ...
            <div
              ...
              title={
                isOnline ? "Active connection detected" : "Intermittent or disconnected status"
              }
            >
              {isOnline ? (
            ...
            <button
              ...
              title={
                language === "hi" ? "प्रिंट या पीडीएफ के रूप में सहेजें" : "Print or Save as PDF"
              }
            >
              ...
              title={
                isOfflineCached
                  ? language === "hi"
                    ...
                    : "Offline Available"
                  : language === "hi"
                    ? "ऑफ़लाइन उपयोग के लिए सहेजें"
                    : "Save for Offline"
              }
            >
              <Database
                className={`w-3.5 h-3.5 ${isOfflineCached ? "text-white animate-pulse" : "text-stone-300"}`}
              />
              <span>
                {isOfflineCached
                  ? language === "hi"
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="space-y-0.5 mt-1.5">
                        ...
                        >
                          <svg
                            className="w-4 h-4 text-emerald-500 shrink-0 fill-current"
                            viewBox="0 0 24 24"
                          >
            ...
            >
              <Bookmark
                className={`w-3.5 h-3.5 ${isSaved ? "fill-stone-900 text-stone-900" : "text-stone-300"}`}
              />
              <span>
                {isSaved
                  ? language === "hi"
        ...
        >
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span
                className={`text-[9.5px] font-mono font-bold uppercase tracking-widest px-2.5 py-0.5 rounded leading-none select-none ${
                  meta.isStateService
              ...
              <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span>
                    {isTranslating
                      ...
                      : translatedDescription
                        ...
                        : language === "hi"
                          ? "हिन्दी में अनुवाद"
                          : `Translate to ${LANGUAGE_NAMES[language] || "Language"}`}
                  </span>
                </button>
                ...
                {translatedDescription && (
                  <span className="text-[9px] font-mono text-stone-400 uppercase tracking-widest flex items-center gap-1.5">
                    ...
                    {language === "hi"
                      ? "एआई द्वारा अनुवादित"
                      : `AI Translated to ${LANGUAGE_NAMES[language] || "Language"}`}
                  </span>
                )}
              </div>
            </div>
      ...
      <div
        className="flex border-b border-stone-200 overflow-x-auto bg-stone-50 select-none scrollbar-none sticky top-0 z-10"
        id="dossier-tabs-row"
      >
        {[
          {
            id: "overview",
            label: language === "hi" ? "प्राधिकरण और पात्रता" : "Agency & Eligibility",
            icon: Building,
          },
          {
            id: "documents",
            label: language === "hi" ? "आवश्यक दस्तावेज / सुधार" : "Document Rules & Updates",
            icon: FileText,
          },
          {
            id: "procedure",
            label:
              language === "hi" ? "आवेदन मार्गदर्शिका (Wizard)" : "Step-by-Step Guide (Wizard)",
            icon: Scroll,
          },
          {
            id: "form",
            label: language === "hi" ? "लाइव आवेदन फॉर्म (Live)" : "Online Web Form (Live)",
            icon: ClipboardCheck,
          },
          {
            id: "centers",
            label:
              language === "hi"
                ? "भौतिक पंजीकरण केंद्र (" + searchedCenters.length + ")"
                : "Physical Center Finder (" + searchedCenters.length + ")",
            icon: MapPin,
          },
          {
            id: "support",
            label: language === "hi" ? "हेल्पलाइन और सोशल" : "Helpline & Social Point",
            icon: Phone,
          },
        ].map((tab) => {
      ...
      <div className="p-6 md:p-8" id="dossier-panels-container">
        ...
        {(isOfflineCached || !isOnline) && (
          <div
            className={`mb-6 p-3.5 rounded-2xl border flex flex-col sm:flex-row sm:items-center justify-between gap-3 font-sans transition-all duration-300 ${
              !isOnline
          ...
          >
            <div className="flex items-start gap-2.5">
              <span className="text-base mt-0.5 shrink-0">{!isOnline ? "⚠️" : "✓"}</span>
                ...
                <h5 className="text-xs font-bold font-sans">
                  {!isOnline
                    ? language === "hi"
                      ...
                      : "Offline Mode Active"
                    : language === "hi"
                      ? "ऑफ़लाइन उपलब्धता सुरक्षित"
                      : "Offline Cache Confirmed"}
                </h5>
                <p className="text-[11px] text-stone-600 leading-normal font-sans">
                  {!isOnline
                    ? isOfflineCached
                      ? language === "hi"
                        ? "आप वर्तमान में ऑफ़लाइन हैं। इस सेवा का स्थानीय रूप से सहेजा गया विवरण प्रदर्शित हो रहा है।"
                        : "You are currently offline. Viewing the locally cached copy of this citizen service checklist."
                      : language === "hi"
                        ? "कनेक्टिविटी नहीं मिली। यह सेवा ऑफ़लाइन सहेजी नहीं गई है। कृपया ऑनलाइन होने पर 'ऑफलाइन' सक्षम करें।"
                        : "No internet connection detected. This service has not been cached for offline use yet."
                    : language === "hi"
                      ? "यह चेकलिस्ट स्थानीय स्तर पर ऑफलाइन उपयोग के लिए सहेजी गई है। जब आपके पास इंटरनेट कनेक्टिविटी नहीं होगी, तब भी यह सुलभ रहेगी।"
                      : "This checklist is cached locally. It will remain accessible even when you experience intermittent or no network connectivity."}
                </p>
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-4">
                  <div className="border border-stone-200 rounded-2xl p-5 space-y-3">
                    <h3 className="font-display font-black text-slate-950 text-sm tracking-tight flex items-center gap-2">
                      ...
                      <span>
                        {language === "hi"
                          ? "नियमावली और पात्रता शर्तें"
                          : "Terms & Eligibility Conditions"}
                      </span>
                    </h3>
                    ...
                    <div className="space-y-2.5 pt-2">
                      {meta.eligibilityConditions.map((cond, index) => (
                        <div
                          key={index}
                          className="flex items-start gap-2 text-xs leading-relaxed text-stone-750"
                        >
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <strong className="text-xs font-black text-stone-900 uppercase tracking-tight">
                          {language === "hi"
                            ? "तत्काल / दूत आवेदन विकल्प"
                            : "Tatkal Express Processing Scheme"}
                        </strong>
                        <span
                          className={`text-[8px] font-mono font-bold uppercase tracking-wider px-1.5 py-0.2 rounded-sm leading-none ${
                            meta.tatkalOption.available
                              ? "bg-amber-655 text-white"
                      ...
                      {meta.tatkalOption.available && (
                        <div className="p-2.5 bg-white border border-amber-200 rounded-xl inline-grid grid-cols-2 gap-4 text-[10.5px] font-mono font-bold font-sans">
                          <div>
                            <span className="text-stone-400 block pb-0.5 select-none text-[8.5px] uppercase">
                              TATKAL TIMELINE
                            </span>
                            <span className="text-amber-800 font-extrabold">
                              {meta.tatkalOption.time}
                            </span>
                          </div>
                  ...
                  <div
                    className="border border-amber-200/60 bg-amber-50/20 rounded-2xl p-5 space-y-4 text-left"
                    id="dossier-live-verification-block"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1">
                        <div className="flex items-center gap-1.5">
                          <span className="flex items-center justify-center w-4 h-4 text-[11px] font-black bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 bg-clip-text text-transparent select-none border border-stone-200 rounded-full shadow-3xs bg-white">
                            G
                          </span>
                          <strong className="text-xs font-black text-stone-900 uppercase tracking-tight">
                            {language === "hi"
                              ? "गूगल सर्च लाइव सत्यापन"
                              : "Google Search Live Verification"}
                          </strong>
                        </div>
                    ...
                    {isVerifying ? (
                      <div className="p-4 bg-white border border-stone-150 rounded-xl flex flex-col items-center justify-center space-y-2 select-none animate-pulse">
                        ...
                        <span className="text-[10px] font-mono font-bold text-stone-500">
                          {language === "hi"
                            ? "आधिकारिक डेटा स्रोतों से सत्यापन किया जा रहा है..."
                            : "Filing live search queries on sovereign portals..."}
                        </span>
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <span>
                            {language === "hi" ? "पुनः सत्यापित करें" : "Refresh Live Verification"}
                          </span>
                        </button>
                      </motion.div>
                    ) : (
                      ...
                      >
                        ...
                        <span>
                          {language === "hi"
                            ? "गूगल सर्च द्वारा लाइव सत्यापित करें"
                            : "Cross-Verify Live with Google Search"}
                        </span>
                      </button>
                    )}
                  </div>
                ...
                <div className="space-y-4">
                  <div className="border border-stone-200 bg-stone-50/40 rounded-2xl p-5 space-y-4">
                    <div className="space-y-1.5 text-left">
                      <span className="text-[9px] font-mono font-bold text-stone-400 uppercase tracking-widest block leading-none">
                        {language === "hi"
                          ? "प्राधिकृत प्रशासनिक निकाय"
                          : "Managing Official Agency"}
                      </span>
                  ...
                  <div
                    className="border border-stone-200 bg-[#FF5A2B]/5 rounded-2xl p-5 space-y-3.5 text-left"
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        {language === "hi" ? "वेब लिंक सुरक्षित कॉपी करें" : "Copy Service Link"}
                      </span>
                    </button>
                  </div>
                </div>
              ...
              <div
                className="border border-stone-200 rounded-2xl p-5 md:p-6 space-y-4 bg-gradient-to-b from-white to-stone-50/50"
                id="relevant-faqs-section"
              >
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="font-display font-black text-slate-950 text-sm tracking-tight flex items-center gap-1.5">
                        ...
                        <span>
                          {language === "hi"
                            ? "अक्सर पूछे जाने वाले प्रश्न (Relevant FAQs)"
                            : "Relevant FAQs & Citizen Clarifications"}
                        </span>
                      </h3>
                    </div>
                        ...
                        <button
                          ...
                          className={`w-full p-4 text-left flex items-start justify-between gap-3 font-semibold text-xs text-stone-900 hover:text-blue-700 transition-colors select-none cursor-pointer ${
                            isOpen
                              ...
                              : "bg-stone-50/20 hover:bg-stone-50/60"
                          }`}
                              ...
                              <div className="p-4 pt-3 text-xs text-stone-700 leading-relaxed bg-white border-t border-stone-100 font-sans font-medium space-y-3">
                                ...
                                <div className="flex items-center justify-between pt-2 border-t border-dashed border-stone-150 text-[10px] font-mono text-stone-500">
                                  ...
                                  >
                                    ...
                                    <span>
                                      {language === "hi" ? "उत्तर कॉपी करें" : "Copy Answer"}
                                    </span>
                                  </button>
                                  ...
                                  >
                                    <span>
                                      {isVoted
                                        ? "✓ " + (language === "hi" ? "सहायक माना गया" : "Helpful")
                                        : "👍 " +
                                          (language === "hi"
            ...
            >
              ...
              <div className="p-5 border border-orange-200 bg-orange-50/20 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <h3 className="font-extrabold text-stone-900 text-sm">
                      {language === "hi"
                        ? "एकीकृत ई-सेवा दस्तावेज़ मार्गदर्शिका"
                        : "Integrated e-Seva Document Wizard Guide"}
                    </h3>
                  </div>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    triggerToast(
                      language === "hi"
                        ? "आधिकारिक प्रक्रिया और पोर्टल संपर्क देखें"
                        : "View registration procedures and official portal links.",
                      "info",
                    );
                  }}
                ...
                >
                  <span>
                    {language === "hi" ? "आधिकारिक पोर्टल लिंक ➔" : "Official Portal Links ➔"}
                  </span>
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 border border-stone-200 rounded-xl space-y-1">
                  ...
                  <p className="text-[10px] text-stone-500 leading-normal mt-0.5 font-sans">
                    {language === "hi"
                      ? "कार्य दिवस (अधिकतम निर्धारित सीमा)"
                      : "Maximum timeline under Public Guarantee Acts."}
                  </p>
                </div>
              ...
              <div className="p-4.5 bg-stone-50 border border-stone-200 rounded-xl space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="text-[11.5px] font-black text-stone-900 uppercase tracking-wider">
                    {language === "hi"
                      ? "दस्तावेज विज़ार्ड चेकलिस्ट:"
                      : "Document Wizard Requirement Checklist:"}
                  </h4>
                  <span className="text-[10px] font-mono font-bold text-emerald-600 bg-emerald-50 border border-emerald-150 px-1.5 py-0.5 rounded-md">
                    {checkedCountInDossier}/{service.documentsRequired.length}{" "}
                ...
                <div className="flex flex-wrap gap-2 pt-1 font-sans">
                  {service.documentsRequired.map((doc, idx) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full shrink-0 ${isChecked ? "bg-emerald-500 animate-pulse" : "bg-stone-350"}`}
                        ></span>
                        <span className={isChecked ? "line-through decoration-emerald-200/60" : ""}>
                          {doc}
                        </span>
              ...
              <div
                className="bg-stone-900 text-white border border-stone-800 p-5 rounded-2xl space-y-4"
                id="dossier-progress-tracker"
              >
                <div className="flex items-center justify-between border-b border-stone-800 pb-3">
                  <div className="space-y-0.5">
                    ...
                    <h4 className="text-xs font-extrabold text-white">
                      {language === "hi"
                        ? "अपनी वर्तमान चरण स्थिति चुनें"
                        : "Select Your Current Application Stage"}
                    </h4>
                  </div>
                  <div className="text-[10px] font-mono font-bold px-2 py-0.5 bg-stone-800 text-stone-300 rounded border border-stone-700">
                    {language === "hi" ? "चरण" : "Stage"} {currentStepIndex + 1} /{" "}
                    {(language === "hi" ? meta.stepByStep.hi : meta.stepByStep.en).length}
                  </div>
                </div>
                ...
                <div className="relative flex items-center justify-between px-2 pt-2 pb-6 overflow-x-auto scrollbar-none">
                  ...
                  {(language === "hi" ? meta.stepByStep.hi : meta.stepByStep.en).map(
                    (step, idx) => {
                ...
                {(() => {
                  const currentStepStr =
                    (language === "hi" ? meta.stepByStep.hi : meta.stepByStep.en)[
                      currentStepIndex
                    ] || "";
                  ...
                  return (
                    <div className="bg-stone-950 border border-stone-800 p-4 rounded-xl space-y-2.5 relative overflow-hidden">
                      ...
                      <div className="space-y-1">
                        <h5 className="text-xs font-extrabold text-white font-sans">{heading}</h5>
                        {details && (
              ...
              <div className="space-y-4 bg-white border border-stone-200 p-5 rounded-2xl">
                <h4 className="font-extrabold text-stone-900 text-xs uppercase tracking-wider flex items-center gap-1.5 font-sans border-b border-stone-100 pb-2.5">
                  ...
                  {language === "hi"
                    ? "आधिकारिक चरण-दर-चरण प्रक्रिया प्रवाह"
                    : "Official Step-by-Step Allocation Flow"}
                </h4>
                    ...
                    (step, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <strong
                              className={`font-bold block ${isActive ? "text-orange-700" : isCompleted ? "text-stone-700" : "text-stone-900"}`}
                            >
                              {heading}
                            </strong>
                            {isActive && (
                          ...
                          {details && (
                            <p
                              className={`font-normal leading-relaxed text-[11.5px] pr-2 mt-0.5 ${isActive ? "text-stone-700" : isCompleted ? "text-stone-450" : "text-stone-500"}`}
                            >
                              {details}
                            </p>
                          )}
              ...
              <div className="p-5 border border-stone-200 rounded-2xl bg-stone-50/30 space-y-3">
                <h4 className="font-extrabold text-stone-900 text-xs uppercase tracking-wider flex items-center gap-1.5 font-sans">
                  ...
                  {language === "hi"
                    ? "आधिकारिक डिजिटल राज्य / राष्ट्रीय पोर्टल लिंक्स"
                    : "Direct Official State / Federal Registration Ports"}
                </h4>
              ...
              <div className="p-4 bg-brand-cream-card border border-[#E9E6DC] rounded-2xl flex items-start gap-3">
                ...
                <div className="space-y-0.5">
                  <strong className="text-xs text-stone-900 leading-none">
                    {language === "hi"
                      ? "डिजिटल स्कैन मानक निर्देश (MeitY Guidelines)"
                      : "MeitY Digital Scans Submission Protocol:"}
                  </strong>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="w-40 h-1.5 bg-stone-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${service.documentsRequired.length > 0 ? (service.documentsRequired.filter((doc) => preparedDocs["fresh_" + doc]).length / service.documentsRequired.length) * 100 : 0}%`,
                        }}
                      />
                    </div>
                  </div>
                  {service.documentsRequired.length > 0 &&
                  service.documentsRequired.filter((doc) => preparedDocs["fresh_" + doc]).length ===
                    ...
                    <span className="text-stone-400 font-mono text-xs font-black">
                      {service.documentsRequired.length > 0
                        ? Math.round(
                            (service.documentsRequired.filter((doc) => preparedDocs["fresh_" + doc])
                              .length /
                              service.documentsRequired.length) *
                              100,
                          )
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="w-40 h-1.5 bg-stone-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${meta.updateDocuments.length > 0 ? (meta.updateDocuments.filter((doc) => preparedDocs["revision_" + doc]).length / meta.updateDocuments.length) * 100 : 0}%`,
                        }}
                      />
                    </div>
                  </div>
                  {meta.updateDocuments.length > 0 &&
                  meta.updateDocuments.filter((doc) => preparedDocs["revision_" + doc]).length ===
                    meta.updateDocuments.length ? (
                    ...
                    <span className="text-stone-400 font-mono text-xs font-black">
                      {meta.updateDocuments.length > 0
                        ? Math.round(
                            (meta.updateDocuments.filter((doc) => preparedDocs["revision_" + doc])
                              .length /
                              meta.updateDocuments.length) *
                              100,
                          )
                  ...
                  <div className="flex items-center justify-between pl-1">
                    <div className="space-y-1">
                      <span className="text-[8.5px] font-mono tracking-wider font-extrabold text-stone-400 uppercase block leading-none">
                        {language === "hi"
                          ? "श्रेणी 1: नवीन जारी करने हेतु"
                          : "CASE A: FRESH ISSUANCE DETAILS"}
                      </span>
                      <h3 className="font-display font-black text-slate-950 text-sm tracking-tight flex items-center gap-1.5">
                        <span>
                          {language === "hi"
                            ? "नए कार्ड / प्रमाण पत्र के लिए आवश्यक"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-0.5 flex-1 min-w-0">
                            <span
                              className={`font-bold block transition-all duration-200 text-xs ${
                                isPrepared
                            ...
                            <span className="text-[10px] text-slate-450 block italic leading-snug">
                              {language === "hi"
                                ? "अभिलेख के साथ मूल प्रति संलग्न करें।"
                                : "Upload scanning copies matching physical records."}
                            </span>
                          </div>
                          {isPrepared && (
                ...
                <div className="border border-stone-200 rounded-3xl p-5 space-y-4 shadow-3xs bg-white relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between pl-1">
                    <div className="space-y-1">
                      <span className="text-[8.5px] font-mono tracking-wider font-extrabold text-stone-400 uppercase block leading-none">
                        {language === "hi"
                          ? "श्रेणी 2: बायोमेट्रिक्स / सुधार हेतु"
                          : "CASE B: REVISIONS / BIO UPDATES"}
                      </span>
                      <h3 className="font-display font-black text-slate-950 text-sm tracking-tight flex items-center gap-1.5">
                        <span>
                          {language === "hi"
                            ? "सुधार और बायोमेट्रिक अपडेट हेतु आवश्यक"
                            : "Correction & Update Requirements"}
                        </span>
                      </h3>
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-0.5 flex-1 min-w-0">
                            ...
                            <span className="text-[10px] text-slate-450 block italic leading-snug">
                              {language === "hi"
                                ? "अभिलेख संशोधन हेतु सहायक वैध पत्र सम्मलित करें।"
                                : "Required to append legal references for modification vetting."}
                            </span>
                          </div>
                          {isPrepared && (
          ...
          {activeTab === "centers" && (
            ...
            >
              ...
              <div className="bg-stone-50 border border-stone-200 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="space-y-1 text-center md:text-left">
                  <h4 className="text-xs font-black text-stone-900 uppercase tracking-tight">
                    {language === "hi"
                      ? "पिन कोड द्वारा नजदीकी ई-गवर्नेंस केंद्र खोजें"
                      : "Locate Physical Registration Centers Nearby"}
                  </h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-5" id="locator-layout-grid">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <span
                            className={`text-[9px] font-mono px-2 py-0.2 rounded font-extrabold shrink-0 truncate ${
                              isSelected
                                ? "bg-[#FF5A2B] text-white"
                        ...
                        <p
                          className={`text-[10.5px] leading-relaxed font-sans mt-1 ${
                        ...
                        <div className="mt-3 pt-2.5 border-t border-dashed border-white/10 flex items-center justify-between text-[10px] font-mono text-stone-400">
                          ...
                          <span className="font-bold underline">
                            {language === "hi" ? "मैप देखें" : "Show Pin ➔"}
                          </span>
                        </div>
                      </div>
                    );
                ...
                <div
                  className="md:col-span-7 border border-stone-200 rounded-3xl overflow-hidden min-h-[350px] bg-stone-50 relative flex flex-col justify-between"
                  id="map-mock-box"
                >
                  ...
                  <div className="absolute inset-0 z-0 bg-[#E8ECE9] overflow-hidden pointer-events-none select-none">
                    ...
                    >
                      <path
                        d="M 0,100 Q 150,120 300,100 T 600,150"
                        fill="none"
                        stroke="#FFFFFF"
                        strokeWidth="8"
                      />
                          ...
                          <div className="relative group/pin">
                            <MapPin
                              className={`w-7 h-7 drop-shadow-md transition-all ${
                                isSelected
                                  ? "text-orange-650 scale-125"
                                  : "text-slate-650 hover:text-stone-900"
                              }`}
                            />
                  ...
                  <div className="relative z-10 m-3.5 p-4 bg-white/95 backdrop-blur-md border border-stone-200/85 rounded-2xl shadow-sm space-y-2 mt-auto text-left w-5/6 max-w-sm">
                    ...
                    <div className="pt-2.5 border-t border-stone-105 grid grid-cols-2 gap-3 text-[9.5px] font-mono text-stone-600">
                      <div>
                        <span className="text-stone-400 block pb-0.2 text-[8px] uppercase select-none">
                          Call Desk
                        </span>
                        <span className="font-extrabold text-[#FF5A2B]">
            ...
            >
              <div className="text-left space-y-1.5">
                <h3 className="font-display font-black text-slate-950 text-sm tracking-tight">
                  {language === "hi"
                    ? "आधिकारिक सहायता डेस्क और सामाजिक संपर्क"
                    : "Verified Administrative Helpdesks & Social Point Links"}
                </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5" id="support-cards-grid">
                ...
                <div className="border border-stone-200 bg-stone-50/40 rounded-2xl p-5 text-left flex flex-col justify-between hover:border-brand-coral/40 transition">
                  <div className="space-y-2">
                    ...
                    <strong className="text-xs font-black block text-stone-900 leading-none pt-1">
                      {language === "hi"
                        ? "ई-प्रमाण टोल-फ्री हेल्पलाइन"
                        : "Official Toll-Free Support"}
                    </strong>
                  ...
                  <div className="pt-4 mt-2 border-t border-stone-150">
                    <span className="text-lg font-mono font-black text-slate-950 block">
                      {meta.helpline}
                    </span>
                    <span className="text-[9px] uppercase font-mono tracking-widest text-[#FF5A2B] font-extrabold block mt-0.5">
                      NATIONAL LINE
                    </span>
                  </div>
                </div>
                ...
                <div className="border border-stone-200 bg-stone-50/40 rounded-2xl p-5 text-left flex flex-col justify-between hover:border-blue-400/40 transition">
                  <div className="space-y-2">
                    ...
                    <strong className="text-xs font-black block text-stone-900 leading-none pt-1">
                      {language === "hi"
                        ? "आधिकारिक सोशल मीडिया प्रभाग"
                        : "Verified X (Twitter) Support Cell"}
                    </strong>
                    <p className="text-[10.5px] text-stone-550 leading-relaxed font-sans">
                      {language === "hi"
                  ...
                  <div className="pt-4 mt-2 border-t border-stone-150">
                    <span className="text-xs font-mono font-extrabold text-blue-700 block truncate hover:underline">
                      <a
                        href={`https://x.com/${meta.socialX.replace("@", "")}`}
                        target="_blank"
                        rel="noreferrer"
                      >
                        {meta.socialX} ↗
                    ...
                    <span className="text-[9px] uppercase font-mono tracking-widest text-stone-400 font-extrabold block mt-0.5">
                      OFFICIAL MEDIA DISPATCH
                    </span>
                  </div>
                </div>
                ...
                <div className="border border-stone-200 bg-stone-50/40 rounded-2xl p-5 text-left flex flex-col justify-between hover:border-emerald-500/40 transition">
                  <div className="space-y-2">
                    ...
                    <strong className="text-xs font-black block text-stone-900 leading-none pt-1">
                      {language === "hi"
                        ? "डिजिटल नागरिक टेलीग्राम समुदाय"
                        : "Sewa Digital Telegram Hub"}
                    </strong>
                    <p className="text-[10.5px] text-stone-550 leading-relaxed font-sans">
                      {language === "hi"
          ...
          {activeTab === "form" && (
            ...
            >
              {submittedArn ? (
                ...
                <div
                  className="border border-emerald-500/30 bg-emerald-50/20 rounded-3xl p-6 md:p-8 space-y-6 animate-fade-in"
                  ...
                  <div className="bg-white border border-stone-200 rounded-2xl p-5 font-sans space-y-4 shadow-3xs max-w-lg mx-auto">
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (typeof navigator !== "undefined" && navigator.clipboard) {
                              ...
                              triggerToast(
                                language === "hi"
                                  ? "ARN क्लिपबोर्ड पर कॉपी किया गया!"
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs">
                      <div>
                        ...
                        <span className="font-bold text-stone-850 block truncate">
                          {formData.fullName}
                        </span>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="text-stone-400 block text-[10px] uppercase font-bold tracking-wider">
                          {language === "hi" ? "प्रसंस्करण समय" : "Est. Timeline"}
                        </span>
                        <span className="font-bold text-stone-850 block truncate">
                          {service.processingTime}
                        </span>
                ...
                <div className="space-y-6" id="live-application-form-panel">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="font-display font-black text-xs uppercase text-stone-900 tracking-tight leading-none mb-0.5">
                          {language === "hi"
                            ? "आधिकारिक डिजिटल फॉर्म"
                            : "E-Governance Form Gateway"}
                        </h3>
                        <p className="text-[10px] text-stone-400 font-sans leading-none">
                          {language === "hi"
                            ? `सेवा: ${service.title}`
                            : `Applying for: ${service.title}`}
                        </p>
                      </div>
                    </div>
                      ...
                      {["details", "docs"].map((step, idx) => {
                        ...
                        return (
                          <div key={step} className="flex items-center">
                            {idx > 0 && (
                              <div
                                className={`w-4 h-0.5 ${stepState === "pending" ? "bg-stone-200" : "bg-emerald-500"}`}
                              />
                            )}
                            <div className="flex items-center gap-1 px-2 py-1 rounded-lg">
                              <div
                                className={`w-4.5 h-4.5 rounded-full flex items-center justify-center text-[9.5px] font-mono font-black ${
                                  stepState === "active"
                                    ? "bg-[#FF5A2B] text-white"
                                    : stepState === "completed"
                  ...
                  {formStep === "details" && (
                    <div
                      className="border border-stone-200 rounded-3xl p-5 md:p-6 bg-stone-50/20 space-y-5 animate-fade-in"
                    ...
                    >
                      <div className="border-b border-stone-150 pb-3">
                        <h4 className="font-display font-black text-stone-900 text-sm">
                          {language === "hi"
                            ? "1. आवेदक व्यक्तिगत विवरण एवं संपर्क"
                            : "1. Applicant Personal Profile"}
                        </h4>
                        <p className="text-[11px] text-stone-505 font-sans">
                          {language === "hi"
                            ? "कृपया सही व्यक्तिगत विवरण भरें।"
                            : "Please enter your correct personal profile details."}
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          />
                          {formErrors.fullName && (
                            <p className="text-[10px] text-red-500 font-sans font-bold">
                              {formErrors.fullName}
                            </p>
                          )}
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          >
                            ...
                            <option value="TRANSGENDER">
                              {language === "hi" ? "तीसरा लिंग" : "Transgender"}
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="border-t border-stone-150 pt-4 mt-2 space-y-3">
                        <h5 className="font-bold text-stone-850 text-xs font-sans">
                          {language === "hi"
                            ? "2. स्थायी पता एवं स्थानीय क्षेत्राधिकार"
                            : "2. Residential Address & Local Jurisdiction"}
                        </h5>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          <div className="space-y-1">
                            <label className="text-[10px] font-extrabold text-stone-750 uppercase block">
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-extrabold text-stone-750 uppercase block">
                            {language === "hi" ? "पूरा स्थायी पता *" : "Full Permanent Address *"}
                          </label>
                          <textarea
                            rows={2}
                      ...
                      <div className="pt-3 border-t border-stone-150 flex justify-between">
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (formData.mobile.length !== 10)
                              errors.mobile =
                                language === "hi"
                                  ...
                                  : "Mobile must be 10 numeric digits.";
                            if (formData.pincode.length !== 6)
                              errors.pincode =
                                language === "hi"
                                  ? "पिनकोड ठीक 6 अंकों का होना चाहिए।"
                                  : "Pincode must be 6 numeric digits.";
                            if (!formData.fullAddress.trim())
                              errors.fullAddress =
                                language === "hi"
                                  ? "स्थायी पता आवश्यक है।"
                            ...
                            if (Object.keys(errors).length > 0) {
                              ...
                              triggerToast(
                                language === "hi"
                                  ? "कृपया लाल रंग के चिह्नित त्रुटियों को सुधारें!"
                                  : "Please resolve the highlighted validation issues.",
                                "error",
                              );
                              return;
                            }
                        ...
                        >
                          <span>
                            {language === "hi" ? "दस्तावेज चरण पर जाएं" : "Proceed to Uploads"}
                          </span>
                  ...
                  {formStep === "docs" && (
                    ...
                    >
                      <div className="border-b border-stone-150 pb-3 text-left">
                        <h4 className="font-display font-black text-stone-900 text-sm">
                          {language === "hi"
                            ? "2. सहायक दस्तावेज अपलोड करें"
                            : "2. Document Portfolio Upload"}
                        </h4>
                        <p className="text-[11px] text-stone-505 font-sans">
                          {language === "hi"
                      ...
                      <div className="space-y-4">
                        {service.documentsRequired.map((doc, idx) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className="border border-stone-200 rounded-2xl p-4 bg-white flex flex-col sm:flex-row items-center justify-between gap-4 font-sans"
                            >
                              <div className="text-left space-y-0.5 w-full sm:w-auto">
                                ...
                                <strong className="text-xs font-bold text-stone-800 block leading-tight">
                                  {doc}
                                </strong>
                                <span className="text-[10px] text-stone-500 block leading-none">
                                  Accepted files: PDF, JPG, PNG (Max 5MB)
                                </span>
                              </div>
                                ...
                                {uploaded ? (
                                  <div className="flex items-center gap-2.5 bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-2 text-emerald-800 text-xs">
                                    <div className="text-left">
                                      <span className="font-bold block truncate max-w-[120px] text-emerald-900">
                                        {uploaded.name}
                                      </span>
                                      <span className="text-[9px] text-emerald-600 font-mono block leading-none pt-0.5">
                                        {uploaded.size} • SUCCESS
                                      </span>
                                    </div>
                                    <button
                                      type="button"
                      ...
                      <div className="bg-stone-50 border border-stone-150 p-4 rounded-2xl flex items-start gap-3">
                        ...
                        />
                        <label
                          htmlFor="form-declaration-consent"
                          className="text-[11px] text-stone-600 leading-normal font-sans cursor-pointer select-none text-left"
                        >
                          {language === "hi"
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (!isDeclarationChecked) {
                              triggerToast(
                                language === "hi"
                                  ? "कृपया घोषणा सहमति बॉक्स पर टिक करें!"
                                  : "Please accept the legal declaration checkbox.",
                                "error",
                              );
                              return;
                            }

                            const missingDocs = service.documentsRequired.filter(
                              (doc) => !uploadedFiles[doc],
                            );
                            if (missingDocs.length > 0) {
                              triggerToast(
                                language === "hi"
                                  ? `कृपया आवश्यक सभी दस्तावेज अपलोड करें! शेष: ${missingDocs.join(", ")}`
                                  : `Please provide copies for all required files. Missing: ${missingDocs.join(", ")}`,
                                "error",
                              );
                              return;
                            }
                            ...
                            triggerToast(
                              language === "hi"
                                ? "SHA-256 सुरक्षित हस्ताक्षर प्रक्रिया शुरू..."
                                : "Beginning SHA-256 digital signature signing...",
                              "info",
                            );
                            ...
                            setTimeout(() => {
                              try {
                                ...
                                const appRecord = {
                                  ...
                                  stages: [
                                    ...
                                    },
                                    {
                                      ...
                                      descEn:
                                        "Nodal Desk is checking e-KYC logs against regional property registries.",
                                      descHi:
                                        "राजस्व डेटाबेस तथा आधार डेटाबेस विवरण से मिलान जारी।",
                                      completed: false,
                                    },
                                    {
                                      ...
                                      descEn:
                                        "Local verification officer assigned for asset limit and residential checks.",
                                      descHi:
                                        "पात्रता एवं पारिवारिक आय सीमा का क्षेत्रीय सत्यापन किया जाएगा।",
                                      completed: false,
                                    },
                                    {
                                      ...
                                      descEn:
                                        "Secured certificate generation. Accessible in DigiLocker & Email.",
                                      descHi:
                                        "सत्यापित सुरक्षित प्रमाण पत्र सीधे डाउनलोड या डिजीलॉकर पर सुलभ।",
                                      completed: false,
                                    },
                                  ],
                                };

                                const existingAppsRaw =
                                  localStorage.getItem("sewanadu_applications");
                                const existingApps = existingAppsRaw
                                  ? JSON.parse(existingAppsRaw)
                                  : [];
                                existingApps.unshift(appRecord);
                                localStorage.setItem(
                                  "sewanadu_applications",
                                ...
                                triggerToast(
                                  language === "hi"
                                    ? "आवेदन राजस्व लेजर पर सफलतापूर्वक दर्ज!"
                                    : "Application logged on SewaNadu revenue node!",
                                  "success",
                                );
                              } catch (e) {
                                console.error(e);
                        ...
                        >
                          {isFormSubmitting ? (
                            <>
                              ...
                              <span>
                                {language === "hi" ? "जमा किया जा रहा है..." : "Filing Ledger..."}
                              </span>
                            </>
                          ) : (
                            <>
                              ...
                              <span>
                                {language === "hi" ? "डिजिटल फॉर्म सबमिट करें" : "Submit Form"}
                              </span>
                            </>
                          )}
                        </button>
        ...
        {relatedServices.length > 0 && (
          <div
            className="mt-8 pt-8 border-t border-stone-200/80 dark:border-slate-800"
            id="dossier-related-services-section"
          >
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-display font-black text-slate-900 dark:text-stone-100 text-sm tracking-tight">
                    {language === "hi"
                      ? "इस विभाग की संबंधित अन्य सेवाएँ"
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {onToggleSave && (
                          ...
                          >
                            <Bookmark
                              className={`w-3.5 h-3.5 ${isSaved ? "fill-rose-600 text-rose-600" : ""}`}
                            />
                          </button>
                        )}
                      </div>
      ...
      <div
        className="bg-[#FAF9F5] border-t border-stone-200/80 p-5 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-4"
        id="dossier-panel-footer"
      >
        <div>
          <button
          ...
          >
            ...
            <span>
              {language === "hi"
                ? "नागरिक चेकलिस्ट (TXT) डाउनलोड करें"
                : "Download Citizen Dossier Checklist (TXT)"}
            </span>
          </button>
        </div>
        ...
        <div className="flex gap-3 w-full sm:w-auto justify-end">
          ...
          <button
            onClick={() => {
              ...
              triggerToast(
                language === "hi"
                  ? "लाइव आवेदन फॉर्म पोर्टल लोड किया गया"
                  : "Live interactive application form loaded.",
                "success",
              );
            }}
