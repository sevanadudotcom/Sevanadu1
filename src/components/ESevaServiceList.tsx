...
const contentTrans = {
  en: {
    ...
    heroDesc:
      "Apply for Aadhaar, PAN, Passport, Driving Licence, Ration Card and 100+ Indian government services – with the complete checklist, fees and timelines, in your language.",
  ...
  hi: {
    ...
    heroDesc:
      "आधार, पैन, पासपोर्ट, ड्राइविंग लाइसेंस, राशन कार्ड और 100+ भारतीय सरकारी सेवाओं के लिए आवेदन करें - अपनी भाषा में पूरी चेकलिस्ट, शुल्क और समय सीमा के साथ।",
...
const getServiceProTip = (service: ESevaService, language: "en" | "hi") => {
  ...
  return (
    categoryTips[service.category]?.[language] ||
    (language === "hi"
...
export default function ESevaServiceList({
  ...
  const [sortBy, setSortBy] = useState<"RELEVANCE" | "ALPHABETICAL" | "NEWEST" | "POPULARITY">(
    "RELEVANCE",
  );
  ...
  const [selectedQuickApplyService, setSelectedQuickApplyService] = useState<ESevaService | null>(
    null,
  );
  ...
  const getServiceTutorial = (service: ESevaService): TutorialStep[] => {
      ...
      return [
        {
          ...
          descriptionEn:
            "Head to the UIDAI website to fill out the pre-enrolment form. This reserves your data, saving valuable time at the offline center.",
          descriptionHi:
            "यूआईडीएआई की वेबसाइट पर जाएं और प्री-एनरोलमेंट फॉर्म भरें। इससे आपका डेटा सिंक हो जाता है और ऑफलाइन केंद्र पर समय बचता है।",
          checklistLabelEn: "Verify you have these in hand:",
          checklistLabelHi: "जांचें कि आपके पास ये दस्तावेज हैं:",
          checklistEn: [
            "Active Mobile number linked with any ID",
            "Proof of Identity (POI) - e.g. Voter ID, PAN",
            "Proof of Address (POA) - e.g. Ration Card, Electricity bill",
          ],
          checklistHi: [
            "सक्रिय मोबाइल नंबर",
            "पहचान पत्र (POI) - जैसे वोटर आईडी, पैन कार्ड",
            "पते का प्रमाण (POA) - जैसे राशन कार्ड, बिजली बिल",
          ],
          proTipEn: "Double check that the spellings on your POI match your address proof exactly.",
          proTipHi:
            "सुनिश्चित करें कि आपके पहचान पत्र पर स्पेलिंग आपके पते के प्रमाण से बिल्कुल मेल खाती हो।",
        ...
        },
        {
          ...
          descriptionEn:
            "Choose your nearest 'Aadhaar Seva Kendra' (ASK) and select a convenient 15-minute slot. Download the generated appointment slip with QR code.",
          descriptionHi:
            "अपने नजदीकी 'आधार सेवा केंद्र' (ASK) का चयन करें और अपनी सुविधा के अनुसार 15 मिनट का स्लॉट बुक करें। QR कोड वाली रसीद डाउनलोड करें।",
          checklistLabelEn: "Appointment preparation checklist:",
          checklistLabelHi: "अपॉइंटमेंट की तैयारी चेकलिस्ट:",
          checklistEn: [
            "Download and print Appointment Slip",
            "Keep original documents ready (copies are not accepted for physical verification)",
            "Plan to arrive 15 minutes prior to slot",
          ],
          checklistHi: [
            "अपॉइंटमेंट पर्ची डाउनलोड और प्रिंट करें",
            "मूल दस्तावेज तैयार रखें (सत्यापन के लिए फोटोकॉपी मान्य नहीं है)",
            "निर्धारित समय से 15 मिनट पहले पहुंचें",
          ],
        ...
        },
        {
          ...
          descriptionEn:
            "Visit the Aadhaar center. At your designated counter, the executive will capture your fingerprints, iris scans, and a fresh headshot picture.",
          descriptionHi:
            "आधार केंद्र पर जाएं। निर्दिष्ट काउंटर पर, कर्मचारी आपके उंगलियों के निशान, आंखों की पुतली का स्कैन और एक नया फोटो लेंगे।",
          checklistLabelEn: "At the kiosk, make sure to:",
          checklistLabelHi: "सत्यापन खिड़की पर इन बातों का ध्यान रखें:",
          checklistEn: [
            "Review the spellings on the operator's display screen prior to approval",
            "Ensure iris camera is at eye level",
            "Pay the official ₹50 charge (if updating details)",
          ],
          checklistHi: [
            "सबमिट करने से पहले ऑपरेटर की स्क्रीन पर स्पेलिंग जरूर जांचें",
            "सुनिश्चित करें कि आइरिस कैमरा आंखों के स्तर पर हो",
            "यदि विवरण अपडेट कर रहे हैं तो ₹50 शुल्क का भुगतान करें",
          ],
          proTipEn:
            "Always ask for a physical printed acknowledgment sheet before leaving the desk.",
        ...
        },
        {
          ...
          descriptionEn:
            "Once approved, a secure digital PDF copy of your card (e-Aadhaar) can be downloaded via OTP. Your physical card will be dispatched via India Post.",
          descriptionHi:
            "मंजूरी मिलने के बाद, आपके कार्ड की एक सुरक्षित डिजिटल पीडीएफ कॉपी (ई-आधार) ओटीपी के जरिए डाउनलोड की जा सकती है। मूल कार्ड डाक से भेजा जाएगा।",
          checklistLabelEn: "To open your downloaded PDF:",
          checklistLabelHi: "डाउनलोड की गई पीडीएफ को खोलने के लिए:",
          checklistEn: [
            "Password format: First 4 letters of your name in CAPITALS + Year of Birth (e.g., ANIK1995)",
            "Verify digital signature validity in Adobe PDF Reader (it should show a green check mark)",
          ],
          checklistHi: [
            "पासवर्ड का प्रारूप: आपके नाम के पहले 4 अक्षर कैपिटल में + जन्म का वर्ष (जैसे, ANIK1995)",
            "एडोब पीडीएफ रीडर में डिजिटल हस्ताक्षर की वैधता जांचें (यह हरा टिक मार्क दिखाना चाहिए)",
          ],
          proTipEn: "e-Aadhaar is legally equal to a physical card in all government services.",
          proTipHi:
            "ई-आधार सभी सरकारी सेवाओं में भौतिक कार्ड के बिल्कुल बराबर कानूनी रूप से मान्य है।",
    ...
    if (
      ...
      service.id.includes("pan") ||
      titleLower.includes("permanent account")
    ) {
      return [
        {
          id: 1,
          ...
          descriptionEn:
            "Access NSDL (Protean) or UTIITSL website. Select Form 49A as an 'Indian Citizen', and 'Individual' as candidate category.",
          descriptionHi:
            "NSDL (प्रोटियन) या UTIITSL वेबसाइट पर जाएं। 'भारतीय नागरिक' के रूप में फॉर्म 49A और श्रेणी के रूप में 'व्यक्तिगत' चुनें।",
          checklistLabelEn: "Form 49A inputs checklist:",
          checklistLabelHi: "फॉर्म 49A भरने के लिए जरूरी बातें:",
          checklistEn: [
            "Aadhaar number (linked with active mobile)",
            "Exact full name & initials",
            "Correct Date of Birth matching Aadhaar",
          ],
          checklistHi: [
            "आधार नंबर (सक्रिय मोबाइल नंबर से जुड़ा हुआ)",
            "सटीक पूरा नाम और उपनाम (सरनेम)",
            "आधार के समान जन्मतिथि",
          ],
          proTipEn:
            "Select both 'Physical PAN Card and e-PAN' option to receive the PVC card by mail.",
          proTipHi:
            "डाक द्वारा प्लास्टिक कार्ड प्राप्त करने के लिए 'भौतिक पैन कार्ड और ई-पैन' दोनों का विकल्प चुनें।",
        ...
        },
        {
          ...
          descriptionEn:
            "Opt for 'Paperless e-KYC and e-Sign'. This reads your details directly from Aadhaar via secure OTP authentication, saving you from posting physical papers.",
          descriptionHi:
            "'पेपरलेस ई-केवाईसी और ई-साइन' का विकल्प चुनें। यह सुरक्षित ओटीपी ऑथेंटिकेशन के माध्यम से आधार से आपका विवरण पढ़ेगा, जिससे दस्तावेज पोस्ट करने की आवश्यकता नहीं होगी।",
          checklistLabelEn: "Aadhaar e-KYC steps:",
          checklistLabelHi: "आधार ई-केवाईसी चरण:",
          checklistEn: [
            "Wait for UIDAI SMS token",
            "Enter the 6-digit OTP code in the input modal",
            "Agree to share Aadhaar demographic photo",
          ],
          checklistHi: [
            "UIDAI एसएमएस टोकन की प्रतीक्षा करें",
            "इनपुट बॉक्स में 6-अंकों का ओटीपी कोड दर्ज करें",
            "आधार फोटोग्राफ साझा करने के लिए सहमति दें",
          ],
          proTipEn:
            "If the OTP isn't received in 60 seconds, check if your phone storage is full or tap 'Resend OTP'.",
          proTipHi:
            "यदि 60 सेकंड में ओटीपी प्राप्त नहीं होता है, तो जांचें कि आपके फोन में नेटवर्क है या 'ओटीपी पुनः भेजें' दबाएं।",
        ...
        },
        {
          ...
          descriptionEn:
            "Pay the prescribed application fee to complete NSDL dispatch queue mapping.",
          descriptionHi:
            "NSDL प्रेषण कतार को एक्टिवेट करने के लिए निर्धारित आवेदन शुल्क का भुगतान करें।",
          checklistLabelEn: "Payment options & details:",
          checklistLabelHi: "भुगतान क्रेडेंशियल और शुल्क जानकारी:",
          checklistEn: [
            "Official Fee: ₹107 (including GST)",
            "UPI, Debit Card, or Net Banking are instant",
            "Note down the Payment Transaction Reference Number",
          ],
          checklistHi: [
            "आधिकारिक शुल्क: ₹107 (जीएसटी सहित)",
            "यूपीआई या डेबिट कार्ड से तुरंत भुगतान होता है",
            "भुगतान का ट्रांजैक्शन रेफरेंस नंबर नोट कर लें",
          ],
          proTipEn:
            "Upon successful receipt, you will earn a 15-digit Acknowledgement Number instantly.",
          proTipHi:
            "सफल भुगतान पर, आपको तुरंत 15 अंकों का पावती संख्या (Acknowledgement Number) प्राप्त होगी।",
        ...
        },
        {
          ...
          descriptionEn:
            "Use your 15-digit acknowledgement number to fetch the newly generated e-PAN card PDF within 24 to 48 hours.",
          descriptionHi:
            "24 से 48 घंटों के भीतर नए जेनरेट किए गए ई-पैन कार्ड की पीडीएफ प्राप्त करने के लिए अपने 15 अंकों के पावती नंबर का उपयोग करें।",
          checklistLabelEn: "Post-approval access checklist:",
          checklistLabelHi: "स्वीकृति के बाद डाउनलोड चरण:",
          checklistEn: [
            "Check register email inbox for the encrypted PDF",
            "Download password is your full Date of Birth in DDMMYYYY format",
            "Verify card on Income Tax e-filing portal",
          ],
          checklistHi: [
            "पंजीकृत ईमेल इनबॉक्स में पासवर्ड-सुरक्षित पीडीएफ देखें",
            "खोलने का पासवर्ड 'DDMMYYYY' प्रारूप में आपकी जन्मतिथि है",
            "आयकर ई-फाइलिंग पोर्टल पर पैन की पुष्टि करें",
          ],
          proTipEn:
            "Digitally signed e-PAN is universally acceptable for opening bank accounts or filing taxes.",
          proTipHi:
            "डिजिटली हस्ताक्षरित ई-पैन बैंक खाता खोलने या टैक्स फाइल करने के लिए पूरी तरह मान्य है।",
      ...
      return [
        {
          ...
          descriptionEn:
            "Register on the Passport Seva official portal. Log in, click 'Apply for Fresh/Reissue Passport' and fill out the detailed form.",
          descriptionHi:
            "पासपोर्ट सेवा के आधिकारिक पोर्टल पर पंजीकरण करें। लॉग इन करें, 'Apply for Fresh/Reissue Passport' पर क्लिक करें और फॉर्म भरें।",
          checklistLabelEn: "Form fields verification checklist:",
          checklistLabelHi: "फॉर्म के विवरण की जांच:",
          checklistEn: [
            "Enter exact full names (no initials like A.K. Prasad - write complete words)",
            "Mention two local emergency contact references",
            "Correct dual parent/spouse identification spellings",
          ],
          checklistHi: [
            "सटीक पूरा नाम लिखें (जैसे A.K. Prasad के स्थान पर Anish Kumar Prasad)",
            "दो स्थानीय आपातकालीन संपर्क संदर्भ दर्ज करें",
            "माता-पिता और जीवनसाथी के नामों की सही स्पेलिंग भरें",
          ],
          proTipEn:
            "Double check your past 1 year of residential addresses to avoid police verification delays.",
          proTipHi:
            "पुलिस सत्यापन में देरी से बचने के लिए पिछले 1 वर्ष के अपने सभी पतों को सही-सही भरें।",
        ...
        },
        {
          ...
          descriptionEn:
            "Complete online fee payment of ₹1,500 (Normal category 36 pages) to enable slot calendar booking.",
          descriptionHi:
            "स्लॉट बुकिंग शुरू करने के लिए ₹1,500 (नॉर्मल कैटेगरी, 36 पेज) के ऑनलाइन शुल्क का भुगतान करें।",
          checklistLabelEn: "Appointment booking checklist:",
          checklistLabelHi: "अपॉइंटमेंट बुकिंग चेकलिस्ट:",
          checklistEn: [
            "Pay securely online (UPI / Credit Card / SBI Chalan)",
            "Select closest Passport Seva Kendra (PSK) or Post Office PSK",
            "Pick date & print green confirmation sheet",
          ],
          checklistHi: [
            "यूपीआई या क्रेडिट कार्ड द्वारा ऑनलाइन सुरक्षित भुगतान करें",
            "अपने नजदीकी पासपोर्ट सेवा केंद्र (PSK) या डाकघर केंद्र (POPSK) को चुनें",
            "तारीख का चयन करें और हरे रंग की अपॉइंटमेंट रसीद प्रिंट करें",
          ],
          proTipEn:
            "Rescheduling is limited to 3 times per application, so choose your appointment date wisely.",
          proTipHi:
            "एक आवेदन पर आप केवल 3 बार अपॉइंटमेंट रीशेड्यूल कर सकते हैं, इसलिए सावधानी से तारीख चुनें।",
        ...
        },
        {
          ...
          descriptionEn:
            "Attend your physical slot at the PSK. Your application will iterate through three internal processing desks: Counter A, B, and C.",
          descriptionHi:
            "निर्धारित समय पर पासपोर्ट केंद्र पहुंचें। आपका आवेदन तीन आंतरिक डेस्क (काउंटर A, B और C) से होकर गुजरेगा।",
          checklistLabelEn: "Carry originals inside a safe folder:",
          checklistLabelHi: "एक सुरक्षित फ़ोल्डर में मूल दस्तावेज़ साथ ले जाएँ:",
          checklistEn: [
            "Appointment Confirmation Slip printout",
            "Aadhaar Card as Address & Identity proof",
            "10th Class Passing Certificate (for Non-ECR status check)",
          ],
          checklistHi: [
            "अपॉइंटमेंट रसीद का प्रिंटआउट",
            "पता और पहचान पत्र के रूप में आधार कार्ड",
            "10वीं कक्षा का मूल प्रमाण पत्र (Non-ECR श्रेणी के सत्यापन हेतु)",
          ],
          proTipEn:
            "Do not carry laptops, pendrives, or bulky luggage inside; they are strictly prohibited in the security cabin.",
          proTipHi:
            "सुरक्षा कारणों से केंद्र के भीतर लैपटॉप, पेनड्राइव या भारी सामान ले जाना वर्जित है।",
        ...
        },
        {
          ...
          descriptionEn:
            "Your application is sent back to your local Police Station. An officer will contact you to physically verify your address.",
          descriptionHi:
            "आपका आवेदन सत्यापन के लिए आपके स्थानीय पुलिस स्टेशन भेजा जाता है। एक पुलिस अधिकारी आपसे पते के सत्यापन के लिए संपर्क करेगा।",
          checklistLabelEn: "Police verification preparation:",
          checklistLabelHi: "पुलिस सत्यापन की तैयारी में रखें ये तैयार:",
          checklistEn: [
            "Original Aadhaar Card and 2 photography passport size",
            "Two reputable neighbors with their Aadhaar cards to sign as witnesses",
            "Original Electricity or Water bill copy",
          ],
          checklistHi: [
            "मूल आधार कार्ड और 2 पासपोर्ट साइज फोटो",
            "सत्यापन गवाह के तौर पर हस्ताक्षर करने के लिए आधार कार्ड के साथ दो पड़ोसी",
            "मूल बिजली या हालिया पानी का बिल",
          ],
          proTipEn:
            "You will receive an automated SMS once the police submit a positive status return to the RTO.",
          proTipHi:
            "जैसे ही police सकारात्मक रिपोर्ट कार्यालय भेजेगी, आपको स्वचालित रूप से एसएमएस प्राप्त हो जाएगा।",
      ...
      return [
        {
          ...
          descriptionEn:
            "Open Sarathi Parivahan portal, select your State, and submit Learner's Licence application details.",
          descriptionHi:
            "सारथी परिवहन पोर्टल खोलें, अपना राज्य चुनें, और लर्नर लाइसेंस आवेदन के लिए विवरण जमा करें।",
          checklistLabelEn: "Mandatory LL details:",
          checklistLabelHi: "लर्नर लाइसेंस हेतु दस्तावेज:",
          checklistEn: [
            "Aadhaar number",
            "Age limit proof documents (18+ for MCW / LMV)",
            "Self-Declaration Medical Form 1 (fill online)",
          ],
          checklistHi: [
            "आधार नंबर",
            "आयु सत्यापन दस्तावेज (पक्का करें कि आपकी आयु 18+ हो)",
            "स्व-घोषणा चिकित्सा फॉर्म 1 (ऑनलाइन भरना होगा)",
          ],
          proTipEn:
            "Many states now support fully online contactless Learner tests using Aadhaar biometric OTP validation.",
          proTipHi:
            "कई राज्य अब आधार ऑथेंटिकेशन के माध्यम से पूरी तरह से ऑनलाइन घर बैठे लर्नर टेस्ट का समर्थन करते हैं।",
        ...
        },
        {
          ...
          descriptionEn:
            "Attempt the online road signs, safety rules, and driver protocol test to get your Learner's licence instantly.",
          descriptionHi:
            "लर्नर लाइसेंस प्राप्त करने के लिए यातायात संकेतों, सुरक्षा नियमों और चालक प्रोटोकॉल की संक्षिप्त ऑनलाइन परीक्षा पास करें।",
          checklistLabelEn: "Preparation tips for sign test:",
          checklistLabelHi: "ऑनलाइन संकेत परीक्षा की तैयारी:",
          checklistEn: [
            "Study the PDF guide on traffic symbols on Sarathi website",
            "Pass rate is typically 60% or higher",
            "You get immediate score results",
          ],
          checklistHi: [
            "सारथी वेबसाइट से यातायात चिन्हों की पीडीएफ गाइड डाउनलोड कर अध्ययन करें",
            "उत्तीर्ण होने के लिए न्यूनतम 60% अंक आवश्यक हैं",
            "परीक्षा परिणाम तुरंत स्क्रीन पर दिखाई देता है",
          ],
          proTipEn:
            "Learner's Licence is valid for exactly 6 months. You can apply for a Permanent Licence after 30 days.",
          proTipHi:
            "लर्नर लाइसेंस जारी होने की तारीख से ठीक 6 महीने तक मान्य रहता है। आप केवल 30 दिनों के बाद स्थायी लाइसेंस के लिए आवेदन कर सकते हैं।",
        ...
        },
        {
          ...
          descriptionEn:
            "Book your Permanent DL slot on Sarathi, pay the fees, and bring your own functional vehicle to your local RTO test track.",
          descriptionHi:
            "सारथी पोर्टल पर स्थायी ड्राइविंग लाइसेंस का स्लॉट बुक करें, शुल्क भरें और परीक्षण के लिए स्वयं का वैध वाहन लेकर आरटीओ ट्रैक पर पहुंचें।",
          checklistLabelEn: "Driving test evaluation patterns:",
          checklistLabelHi: "ट्रैक परीक्षण पैरामीटर:",
          checklistEn: [
            "LMV: Navigate Figure-8, parallel parking, and reverse S-curves without touching poles",
            "Two-Wheeler: Ride slow, maintain balance on narrow track, and signal properly with indicators",
          ],
          checklistHi: [
            "चार पहिया: खंभों को छुए बिना 'Z' या '8' आकृति ट्रैक पर रिवर्स करें",
            "दोपहिया: धीमी गति से चलें, संकीर्ण ज़िग-ज़ैग ट्रैक पर संतुलन रखें और इंडिकेटर्स चालू करें",
          ],
          proTipEn:
            "The officer will fail you instantly if you stall the engine or put your feet down on the track, so practice thoroughly.",
          proTipHi:
            "यदि आपका वाहन बीच में बंद हो जाता है या पैर जमीन पर छू जाते हैं, तो निरीक्षक तुरंत फेल कर सकते हैं; इसलिए पहले अभ्यास करें।",
        ...
        },
        {
          ...
          descriptionEn:
            "Once approved by the inspector, your DL number is generated. A smart PVC chip card is manufactured and mailed via India Post.",
          descriptionHi:
            "परीक्षण उत्तीर्ण करने के बाद, आपका डीएल नंबर स्वीकृत होकर जारी हो जाता है। स्मार्ट चिप-युक्त ड्राइविंग लाइसेंस स्पीड पोस्ट से डिलीवर होगा।",
          checklistLabelEn: "Post-approval access checklist:",
          checklistLabelHi: "स्वीकृति के बाद आवश्यक निगरानी:",
          checklistEn: [
            "Register license copy in DigiLocker or mParivahan app",
            "Keep online PDF copy on phone for immediate access",
            "Verify address is up-to-date in system database",
          ],
          checklistHi: [
            "डिजिलॉकर या एम-परिवहन ऐप पर डिजिटल सुरक्षित कॉपी सहेजें",
            "तुरंत मोबाइल पर उपयोग के लिए पीडीएफ डाउनलोड कर लें",
            "पक्का करें कि सरकारी रजिस्टर में पता सही सुधारा गया है",
          ],
          proTipEn:
            "A digital driving licence in DigiLocker or mParivahan is fully valid under the IT Act.",
          proTipHi:
            "डिजिलॉकर में सहेजा गया ड्राइविंग लाइसेंस कानूनन भौतिक लाइसेंस के समान पूरी तरह मान्य है।",
      ...
      return [
        {
          ...
          descriptionEn:
            "Verify database guidelines to select correct poverty categorization (AAY, BPL, PHH) depending on family income limits.",
          descriptionHi:
            "पारिवारिक वार्षिक आय के आधार पर सही कार्ड श्रेणी (अंत्योदय योजना, गरीबी रेखा से नीचे - BPL, या प्राथमिकता परिवार - PHH) का चयन करें।",
          checklistLabelEn: "Checklist of documents and parameters:",
          checklistLabelHi: "आवश्यक कागजात:",
          checklistEn: [
            "Aadhaar cards of ALL family members link active",
            "Current collective passport family group photograph",
            "Annual income salary certificate",
          ],
          checklistHi: [
            "परिवार के सभी सदस्यों के आधार कार्ड",
            "पूरे परिवार की पारिवारिक समूह तस्वीर",
            "तहसीलदार द्वारा प्रमाणित वार्षिक आय प्रमाण पत्र",
          ],
          proTipEn:
            "The eldest female member of the family is legally registered as the 'Head of Household'.",
          proTipHi:
            "कानूनन परिवार की सबसे बड़ी महिला सदस्य को 'गृहस्वामी' (मुखिया) के रूप में पंजीकृत किया जाना आवश्यक है।",
        ...
        },
        {
          ...
          descriptionEn:
            "Log in to your state's Food and Civil Supplies portal. Complete the comprehensive application and upload scanned papers.",
          descriptionHi:
            "अपने राज्य के खाद्य और नागरिक आपूर्ति विभाग के पोर्टल पर जाएं। संबंधित फॉर्म भरें और दस्तावेजों की पीडीएफ कॉपी अपलोड करें।",
          checklistLabelEn: "Online portal verification:",
          checklistLabelHi: "पोर्टल पर ध्यान रखने योग्य बातें:",
          checklistEn: [
            "Verify bank details for LPG gas subsidy tie",
            "Map Aadhaar number to avoid double-allocation errors",
            "Download generated transaction draft",
          ],
          checklistHi: [
            "एलपीजी गैस सब्सिडी के लिए बैंक खाता सही भरें",
            "दोहरे आवंटन की त्रुटियों से बचने के लिए आधार नंबर लिंक करें",
            "सबमिट कर फाइनल ट्रांजैक्शन रिपोर्ट डाउनलोड करें",
          ],
          proTipEn:
            "Take a clear screenshot of the acknowledgement screen with the registration serial ID.",
        ...
        },
        {
          ...
          descriptionEn:
            "The food department circles a physical visit desk order. A local inspector visits your household to verify claim parameters.",
          descriptionHi:
            "खाद्य विभाग आपके पारिवारिक विवरण की पुष्टि के लिए एक क्षेत्रीय निरीक्षक को पते पर भेजता है जो दावों का सत्यापन करता है।",
          checklistLabelEn: "Keeper preparation checklists:",
          checklistLabelHi: "दौरे के समय तैयार रखने वाली चीजें:",
          checklistEn: [
            "Keep original income records accessible",
            "Introduce neighbors for local references",
            "Stay present at the address during official call slot",
          ],
          checklistHi: [
            "आय के मूल दस्तावेज तैयार रखें",
            "पड़ोसियों को स्थानीय संदर्भ के रूप में उपस्थित रहने को कहें",
            "घोषित पते पर स्वयं उपस्थित रहें",
          ],
          proTipEn: "Being cooperative and present accelerates approval speed immensely.",
          proTipHi:
            "सहयोगात्मक रवैया अपनाने और आवश्यक दस्तावेज सामने रखने से मंजूरी तेजी से मिलती है।",
        ...
        },
        {
          ...
          descriptionEn:
            "Once successfully verified, your family database ledger is mapped to your selected local Fair Price Shop (depot).",
          descriptionHi:
            "सत्यापन पूर्ण होने पर, आपकी पात्रता सूची को क्षेत्र के निकटतम सरकारी राशन भंडार (राशन डिपो) से लिंक कर दिया जाता है।",
          checklistLabelEn: "FPS pickup instructions:",
          checklistLabelHi: "वितरण केंद्र विवरण आवंटन:",
          checklistEn: [
            "Ration Card is dispatched within 15-20 days by Speed Post",
            "Check allocated items digitally on One Nation One Ration Card database",
            "Complete monthly biometry OTP pickup",
          ],
          checklistHi: [
            "स्मार्ट राशन कार्ड 15-20 दिनों में डाक द्वारा भेजा जाता है",
            "वन नेशन वन राशन कार्ड (ONORC) डेटाबेस पर राशन देख सकते हैं",
            "हर महीने डिपो पर फिंगरप्रिंट देकर अनाज ले सकते हैं",
          ],
          proTipEn:
            "You can swipe your Aadhaar biometric at any ration shop nationwide if registered on the ONORC portal.",
          proTipHi:
            "यदि पंजीकृत हैं, तो आप देश भर में किसी भी राशन दुकान से अंगूठा लगाकर राशन प्राप्त कर सकते हैं।",
    ...
    return [
      {
        ...
        descriptionEn:
          "Compile all basic eligibility documents and verify you meet the age and location prerequisites.",
        descriptionHi:
          "सभी मूल दस्तावेजों को एकत्रित करें और जांचें कि क्या आप इस सेवा के आयु व क्षेत्र पात्रता मानदंडों को पूरा करते हैं।",
        checklistLabelEn: "Required items in hand:",
        checklistLabelHi: "तैयार रखने वाली चीजें:",
        checklistEn: [
          "Valid Aadhaar card with mobile linked",
          "Income or address proof certificate",
          "Recent passport size digital photo",
        ],
        checklistHi: [
          "सक्रिय मोबाइल नंबर से जुड़ा आधार कार्ड",
          "आय या निवास प्रमाण पत्र",
          "हालिया पासपोर्ट साइज फोटो",
        ],
        proTipEn: "Keep scanned soft copies of all papers in PDF format below 2MB file size.",
        proTipHi:
          "अपने सभी दस्तावेजों की स्कैंड सॉफ्ट कॉपियों को 2MB से कम साइज की पीडीएफ बनाकर रख लें।",
      ...
      },
      {
        ...
        descriptionEn:
          "Log in to the official service desk website page. Enter basic biographical and contact database inputs.",
        descriptionHi:
          "संबंधित विभाग के आधिकारिक वेब पोर्टल पर लॉग इन करें। बुनियादी व्यक्तिगत और संपर्क विवरण सही-सही भरें।",
        checklistLabelEn: "In the portal form:",
        checklistLabelHi: "ऑनलाइन फॉर्म भरते समय:",
        checklistEn: [
          "Fill spelling fields matching Aadhaar exact layouts",
          "Choose correct service sub-category node",
          "Complete e-KYC if prompted",
        ],
        checklistHi: [
          "आधार के समान नाम और पते की स्पेलिंग भरें",
          "सही उप-श्रेणी विकल्प का चयन करें",
          "कहे जाने पर ई-केवाईसी प्रक्रिया पूरी करें",
        ],
        proTipEn: "Review your application summary draft thoroughly before payment.",
        proTipHi:
          "भुगतान करने से पहले अपने आवेदन पत्र के ड्राफ्ट की एक-एक पंक्ति की समीक्षा अवश्य करें।",
      ...
      },
      {
        ...
        descriptionEn:
          "Pay the prescribed official agency processing fee to submit your file into the server validation queue.",
        descriptionHi:
          "अपने आवेदन को विभाग के मुख्य सर्वर सत्यापन में भेजने के लिए निर्धारित प्रक्रिया शुल्क का भुगतान करें।",
        checklistLabelEn: "Payment options & tips:",
        checklistLabelHi: "भुगतान और शुल्क क्रेडेंशियल:",
        checklistEn: [
          "Pay via instant secure modes (UPI, card, etc)",
          "Note the Transaction ID from payment success receipt",
          "Keep the generated application tracking number",
        ],
        checklistHi: [
          "सुरक्षित माध्यमों जैसे यूपीआई या डेबिट कार्ड से भुगतान करें",
          "भुगतान रसीद से ट्रांजैक्शन आईडी नोट करें",
          "प्राप्त आवेदन ट्रैकिंग संख्या (Tracking No) संभाल कर रखें",
        ],
        proTipEn: "Print the generated PDF acknowledgment receipt immediately as reference.",
        proTipHi:
          "संदर्भ के तौर पर प्राप्त हुई पीडीएफ पावती रसीद को तुरंत प्रिंट या सुरक्षित कर लें।",
      ...
      },
      {
        ...
        descriptionEn:
          "The desk administrative officers complete verification and issue a cryptographically signed digital certificate.",
        descriptionHi:
          "विभाग के प्रशासनिक अधिकारी सत्यापन पूरा करके एक डिजिटल हस्ताक्षरित प्रमाणपत्र जारी करेंगे।",
        checklistLabelEn: "Post-approval download steps:",
        checklistLabelHi: "स्वीकृति के बाद डाउनलोड चरण:",
        checklistEn: [
          "Check portal database status periodically with Tracking ID",
          "Download PDF cert to device secure folder",
          "Import certified copy to DigiLocker",
        ],
        checklistHi: [
          "ट्रैकिंग आईडी से समय-समय पर स्टेटस जांचते रहें",
          "प्रमाण पत्र की पीडीएफ अपने फ़ोन में सहेजें",
          "डिजिलॉकर में सत्यापित कॉपी को जोड़े",
        ],
        proTipEn: "You can verify the official QR verification code on back to check authenticity.",
        proTipHi:
          "प्रामाणिकता साबित करने के लिए आप प्रमाणपत्र के बैकसाइड पर मौजूद सरकारी QR कोड को स्कैन कर सकते हैं।",
      ...
      return [
        {
          ...
          descEn:
            "Visit UIDAI portal, fill online application form, select required supporting documents of Identity/Address, and book an appointment slot at your nearest Aadhaar Seva Kendra.",
          descHi:
            "यूआईडीएआई पोर्टल पर जाएं, ऑनलाइन आवेदन पत्र भरें, पहचान/पते के सहायक दस्तावेज चुनें और अपने नजदीकी आधार सेवा केंद्र में समय निर्धारित करें।",
          durationEn: "15 mins",
          durationHi: "15 मिनट",
          type: "document",
        },
        {
          ...
          titleHi: "बायोमेट्रिक डेटा संग्रह",
          descEn:
            "Visit the Aadhaar Seva Kendra. The operator will capture physical biometrics: 10 fingerprints database verification, dual iris scans, and a digital passport photo.",
          descHi:
            "संबंधित आधार केंद्र पर जाएं। ऑपरेटर उंगलियों के निशान, आंखों की पुतली का स्कैन और एक डिजिटल फोटो कैप्चर करेंगे।",
        ...
        },
        {
          ...
          descEn:
            "The central CIDR database runs de-duplication checks to ensure your biometrics aren't associated with another Aadhaar card.",
          descHi:
            "केंद्रीय यूआईडीएआई डेटाबेस यह सुनिश्चित करने के लिए सत्यापन करेगा कि आपकी बायोमेट्रिक्स किसी और कार्ड से मेल तो नहीं खाती।",
        ...
        },
        {
          ...
          descEn:
            "A physical smart card letter is printed and despatched via India Post (Speed Post) to your address. Simultaneously, you can download the digital copy (e-Aadhaar) securely via OTP.",
          descHi:
            "एक भौतिक आधार पत्र भारतीय डाक द्वारा आपके घर के पते पर भेजा जाएगा। साथ ही, आप ऑनलाइन 'ई-आधार' कॉपी भी डाउनलोड कर सकते हैं।",
      ...
      return [
        {
          ...
          descEn:
            "Fill Form 49A/49AA on UTIITS or Protean (NSDL) portal. Choose between physical PAN card + e-PAN, or e-PAN only.",
          descHi:
            "UTIITS या Protean (NSDL) पोर्टल पर फॉर्म 49A/49AA भरें। भौतिक पैन और ई-पैन दोनों का विकल्प चुनें।",
          durationEn: "20 mins",
          durationHi: "20 मिनट",
          type: "document",
        },
        {
          ...
          descEn:
            "Pay application processing fee and complete e-KYC using Aadhaar OTP authentication. No physical documents need to be mailed if using OTP-based e-KYC.",
          descHi:
            "प्रक्रिया शुल्क का भुगतान करें और आधार ओटीपी ऑथेंटिकेशन के माध्यम से ई-केवाईसी पूरी करें, जिससे दस्तावेज भेजने की आवश्यकता नहीं रहती।",
          durationEn: "5 mins",
          durationHi: "5 मिनट",
          type: "payment",
        },
        {
          ...
          descEn:
            "The Income Tax Department evaluates applications for duplicate PANs. Once verified, a unique 10-character alphanumeric PAN is allocated.",
          descHi:
            "आयकर विभाग आपके आवेदन का मूल्यांकन करता है। सत्यापन के बाद, एक अद्वितीय 10-अक्षर वाला पैन नंबर आवंटित किया जाता है।",
          durationEn: "3-5 days",
          durationHi: "3-5 दिन",
          type: "status",
        },
        {
          ...
          descEn:
            "The e-PAN is emailed to you as a password-protected PDF. The physical high-quality PVC card with QR hologram is manufactured and despatched via post.",
          descHi:
            "ई-पैन आपकी ईमेल आईडी पर पीडीएफ के रूप में भेजा जाता है। भौतिक प्लास्टिक पैन कार्ड डाक से डिलीवर किया जाएगा।",
      ...
      return [
        {
          ...
          descEn:
            "Register on Passport Seva website, complete the online application, upload document checklist, pay the official fee, and book physical appointment slot at your nearest PSK/POPSK.",
          descHi:
            "पासपोर्ट सेवा वेबसाइट पर पंजीकरण करें, फॉर्म भरें, दस्तावेज़ अपलोड करें, आधिकारिक शुल्क का भुगतान करें और केंद्र में अपनी यात्रा बुक करें।",
          durationEn: "30 mins",
          durationHi: "30 मिनट",
          type: "document",
        },
        {
          ...
          descEn:
            "Attend scheduled slot at PSK. Go through counter verification stages: Counter A (Biometric, photo, payment check), Counter B (Original documents check by Verification Officer), Counter C (Granting Officer approval).",
          descHi:
            "तय समय पर PSK पहुंचें। काउंटर A (बायोमेट्रिक्स), काउंटर B (मूल दस्तावेजों की जांच) और काउंटर C (अनुमोदन अधिकारी) की प्रक्रियाओं से गुजरें।",
        ...
        },
        {
          ...
          descEn:
            "The passport system sends electronic requests to your local Police Station. An officer schedules a physical visit to verify your identity, residential address, address proof, and check criminal histories.",
          descHi:
            "पासपोर्ट कार्यालय आपकी स्थानीय पुलिस को सूचित करेगा। पुलिस अधिकारी पते और चरित्र सत्यापन के लिए आपके आवास का दौरा करेंगे।",
        ...
        },
        {
          ...
          descEn:
            "Upon positive police report, Passport printing is queued at the Central Security Printing Press, packaged, and despatched via Speed Post with real-time SMS tracking.",
          descHi:
            "पुलिस रिपोर्ट सकारात्मक होने के बाद, आपका पासपोर्ट केंद्रीय मुद्रण प्रेस में छपेगा और स्पीड पोस्ट द्वारा ट्रैक नंबर के साथ भेजा जाएगा।",
          durationEn: "4-7 days",
          durationHi: "4-7 दिन",
          type: "dispatch",
        },
      ...
      return [
        {
          ...
          descEn:
            "Apply on Sarathi Parivahan portal, upload age/address proofs, pay nominal fee, and take the online/offline road signs test to receive a Learner's Licence valid for 6 months.",
          descHi:
            "सारथी परिवहन पोर्टल पर आवेदन करें, दस्तावेज अपलोड करें और ऑनलाइन यातायात नियमों की परीक्षा उत्तीर्ण कर 6 महीने के लिए वैध लर्नर लाइसेंस प्राप्त करें।",
          durationEn: "1-2 days",
          durationHi: "1-2 दिन",
          type: "document",
        },
        {
          ...
          descEn:
            "After a mandatory wait of 30 days from LL issue, register online on the Sarathi portal for a Permanent Driving Licence and book a driving test slot at your local RTO.",
          descHi:
            "लर्नर लाइसेंस जारी होने के 30 दिन बाद, परिवहन पोर्टल पर स्थायी ड्राइविंग लाइसेंस के लिए सड़क परीक्षण टेस्ट हेतु स्लॉट बुक करें।",
          durationEn: "10 mins",
          durationHi: "10 मिनट",
          type: "office",
        },
        {
          ...
          titleHi: "आरटीओ ड्राइविंग ट्रैक टेस्ट",
          descEn:
            "Visit the RTO test track with your chosen vehicle. Navigate standard physical layouts (such as Figure 8, Parallel Parking, S-turns, Gradient Climbs) in front of an authorized Motor Vehicle Inspector.",
          descHi:
            "आरटीओ टेस्ट ट्रैक पर अपने वाहन के साथ पहुंचे। निरीक्षक के समक्ष समानांतर पार्किंग, 'H' या '8' आकृति ट्रैक पर अपनी ड्राइविंग का सफल प्रदर्शन करें।",
        ...
        },
        {
          ...
          descEn:
            "Once the RTO inspector submits a positive report, your licence is digitally approved, and a chip-based PVC Driving Licence card is manufactured and mailed.",
          descHi:
            "आरटीओ द्वारा परीक्षण स्वीकृत होने के बाद, आपका स्थायी लाइसेंस स्वीकृत हो जाता है और चिप-युक्त स्मार्ट कार्ड डाक द्वारा भेजा जाता है।",
      ...
      return [
        {
          ...
          descEn:
            "Submit family details on state Food Civil Supplies department, upload Aadhaar cards of all members, family photo, and verified income proofs.",
          descHi:
            "खाद्य एवं नागरिक आपूर्ति विभाग के पोर्टल पर आवेदन करें, सभी सदस्यों के आधार कार्ड, सामूहिक फोटो और आय प्रमाण पत्र अपलोड करें।",
          durationEn: "30 mins",
          durationHi: "30 मिनट",
          type: "document",
        },
        {
          ...
          descEn:
            "A designated area supply inspector conducts local physical checks on your family household density and income classification (AAY / BPL / PHH).",
          descHi:
            "नामित क्षेत्र आपूर्ति निरीक्षक गरीबी रेखा वर्गीकरण (BPL/PHH) की पुष्टि के लिए आपके घर या पड़ोस का भौतिक सत्यापन करेंगे।",
        ...
        },
        {
          ...
          descEn:
            "The verified family data ledger is officially tied to your closest Fair Price retail shop for distributing grains and cooking fuel quota.",
          descHi:
            "सत्यापित डेटा को सरकारी राशन दुकान से जोड़ दिया जाता है, जिससे आपके परिवार का मासिक अनाज और ईंधन राशन सुनिश्चित होता है।",
          durationEn: "2-3 days",
          durationHi: "2-3 दिन",
          type: "office",
        },
        {
          ...
          descEn:
            "Receive a physical barcoded NFSA Smart Ration Card from the block circle office or download the digital card through DigiLocker.",
          descHi:
            "ब्लॉक कार्यालय से भौतिक स्मार्ट बारकोडेड राशन कार्ड प्राप्त करें या डिजिलॉकर के माध्यम से अपना डिजिटल राशन कार्ड तुरंत डाउनलोड करें।",
    ...
    return [
      {
        ...
        descEn:
          "Determine specific age, residential, and caste/income eligibility prerequisites. Gather and verify mandatory documents from pre-checksheets.",
        descHi:
          "योजना की पात्रता सूची (जैसे आयु, निवास या श्रेणी) की जांच करें और हमारी चेकलिस्ट के अनुसार सभी दस्तावेज एकत्र करें।",
        durationEn: "1 day",
        durationHi: "1 दिन",
        type: "document",
      },
      {
        ...
        descEn:
          "Access the government service web application, input personal bio-details, scan and upload required verified documents, and securely submit the application.",
        descHi:
          "संबंधित विभाग के ऑनलाइन पोर्टल पर जाएं, मूल विवरण दर्ज करें, दस्तावेज अपलोड करें और आवेदन पत्र सबमिट करें।",
      ...
      },
      {
        ...
        descEn:
          "State or Central designated block desk officers carry out administrative verification, query resolutions, and field checks to approve your applications.",
        descHi:
          "संबंधित विभाग के डेस्क अधिकारी तथा क्षेत्रीय निरीक्षक आपके दस्तावेजों और तथ्यों का भौतिक व प्रशासनिक सत्यापन करते हैं।",
        durationEn: "7-14 days",
        durationHi: "7-14 दिन",
        type: "status",
      },
      {
        ...
        descEn:
          "The service is granted. A digital, digitally-signed PDF is issued (often verified with cryptographic signature) and physical copies are delivered to your address.",
        descHi:
          "कार्य पूर्ण रूप से स्वीकृत होने के बाद डिजिटल हस्ताक्षरित प्रमाण पत्र पीडीएफ के रूप में पोर्टल पर जारी होता है या आपके पते पर भेजा जाता है।",
        durationEn: "3-5 days",
        durationHi: "3-5 दिन",
        type: "digital",
      },
  ...
  const setSearchQuery =
    propsSetSearchQuery !== undefined ? propsSetSearchQuery : setLocalSearchQuery;
  ...
  const [recentSearches, setRecentSearches] = useState<string[]>(() => {
    try {
      ...
      return saved
        ? JSON.parse(saved)
        : ["Aadhaar", "PAN Card", "Passport", "Driving Licence", "PM Kisan"];
    } catch {
  ...
  const renderSearchDropdownOverlay = (onSelect: (query: string) => void, onClose: () => void) => {
    return (
      <div
      ...
      >
        ...
        <div className="p-2.5 bg-stone-50/60 dark:bg-slate-900/40 border-t border-stone-100 dark:border-white/5">
          ...
          <div className="flex flex-wrap gap-1.5">
            {["Aadhaar", "PAN Card", "Passport", "Driving Licence", "Ration Card", "PM Kisan"].map(
              (tag) => (
                <button
                  key={tag}
                  type="button"
  ...
  const renderCategoryFilterPills = (isCatalogView = false) => {
    ...
    return (
      <div
        className={`flex flex-wrap items-center justify-center gap-2 mt-2 select-none ${isCatalogView ? "md:justify-start" : "justify-center"}`}
      >
        ...
        {pills.map((pill) => {
          ...
          return (
            ...
            >
              <PillIcon
                className={`w-3.5 h-3.5 ${isActive ? "text-white animate-pulse" : "text-stone-500 hover:text-stone-705"}`}
              />
              <span>{label}</span>
            </button>
          );
  ...
  const categories = [
    ...
    {
      id: "POPULAR",
      label: language === "hi" ? "लोकप्रिय" : "Popular",
      icon: Sparkles,
      count: language === "hi" ? "ट्रेंडिंग" : "Trending Now",
    },
    {
      id: "IDENTITY",
      label: language === "hi" ? "पहचान पत्र" : "Identity",
      icon: UserCheck,
      count: "Aadhaar, Passport, Voter",
    },
    {
      id: "HEALTH",
      label: language === "hi" ? "स्वास्थ्य" : "Health",
      icon: Heart,
      count: "ABHA, FSSAI, Medical",
    },
    {
      id: "AGRICULTURE",
      label: language === "hi" ? "कृषि एवं किसान" : "Agriculture",
      icon: Sprout,
      count: "PM-Kisan, Subsidies",
    },
    {
      id: "FINANCE",
      label: language === "hi" ? "वित्त एवं कर" : "Finance & Tax",
      icon: Banknote,
      count: "PAN, Tax, GST, MSME",
    },
    {
      id: "EDUCATION",
      label: language === "hi" ? "शिक्षा" : "Education",
      icon: GraduationCap,
      count: "Scholarships, CBSE",
    },
    {
      id: "WELFARE",
      label: language === "hi" ? "कल्याण योजनाएं" : "Welfare",
      icon: ShieldCheck,
      count: "Ration, Pensions",
    },
    {
      id: "LAND",
      label: language === "hi" ? "भूमि एवं संपत्ति" : "Land & Property",
      icon: Landmark,
      count: "7/12, Patta, Mutation",
    },
    {
      id: "LABOUR",
      label: language === "hi" ? "श्रमिक एवं परिवहन" : "Labour & Transport",
      icon: Briefcase,
      count: "DL, e-Shram, EPFO",
    },
    {
      id: "SAVED",
      label: language === "hi" ? "सहेजी गई" : "Saved",
      icon: Bookmark,
      count: `${savedIds.length} saved`,
    },
  ];
  ...
  const activeCategoryName = activeCategoryObj
    ? activeCategoryObj.label.split(" (")[0]
    : activeCategory;
  ...
  const filteredServices = useMemo(() => {
    const list = services.filter((s) => {
      ...
      const matchesSearch =
        s.title.toLowerCase().includes(activeSearchQuery.toLowerCase()) ||
  ...
  const getCategoryTheme = (category: string, titleStr: string) => {
    ...
    if (
      titleLower.includes("kisan") ||
      titleLower.includes("agriculture") ||
      titleLower.includes("apeda")
    )
    ...
    switch (category) {
      ...
      case "FINANCE":
        return "bg-emerald-50 text-emerald-850 border-emerald-200";
      case "HEALTH":
        return "bg-cyan-50 text-cyan-850 border-cyan-200";
      case "LABOUR":
        return "bg-amber-50 text-amber-850 border-amber-200";
      case "LAND":
        return "bg-purple-50 text-purple-850 border-purple-200";
      case "WELFARE":
        return "bg-blue-50 text-blue-850 border-blue-200";
      case "AGRICULTURE":
        return "bg-emerald-50 text-emerald-850 border-emerald-200";
      case "EDUCATION":
        return "bg-violet-50 text-violet-850 border-violet-200";
      default:
  ...
  const getCategoryLabel = (service: ESevaService) => {
    ...
    if (
      ...
      return language === "hi" ? "कृषि" : "Agriculture";
    if (
      titleLower.includes("scholarship") ||
      titleLower.includes("education") ||
      titleLower.includes("school")
    )
      return language === "hi" ? "शिक्षा" : "Education";

    switch (service.category) {
      case "IDENTITY":
        return language === "hi" ? "पहचान पत्र" : "Identity";
      case "FINANCE":
        return language === "hi" ? "वित्त" : "Finance";
      case "HEALTH":
        return language === "hi" ? "स्वास्थ्य" : "Health";
      case "LABOUR":
        return language === "hi" ? "रोजगार" : "Labour";
      case "LAND":
        return language === "hi" ? "राजस्व" : "Land";
      case "WELFARE":
        return language === "hi" ? "कल्याण" : "Welfare";
      default:
        return language === "hi" ? "अन्य" : "General";
    }
  };
  ...
  const isSearchOrFilterActive =
    activeSearchQuery !== "" || activeCategory !== "ALL" || viewCatalog;
    ...
    <div id="service-directory" className="space-y-8 animate-fade-in font-sans">
      {!isSearchOrFilterActive ? (
        ...
        <div className="space-y-12">
              ...
              <div className="p-1 px-1.5 flex flex-col sm:flex-row sm:items-center bg-white border border-[#E5E2D9] rounded-2xl shadow-sm hover:border-brand-coral/40 focus-within:border-brand-coral/60 focus-within:ring-3 focus-within:ring-brand-coral/10 transition gap-2">
                ...
                <div className="relative flex items-center px-3 py-1 bg-stone-50 hover:bg-stone-100 rounded-xl transition cursor-pointer shrink-0">
                  ...
                  >
                    ...
                    <option value="POPULAR">
                      {language === "hi" ? "लोकप्रिय (Popular)" : "Popular"}
                    </option>
                    <option value="SAVED">
                      {language === "hi" ? "सहेजी गई सेवाएं (Saved)" : "Saved Services"}
                    </option>
                    <option value="HEALTH">
                    ...
                    <option value="FINANCE">
                      {language === "hi" ? "वित्तीय (Financial)" : "Financial"}
                    </option>
                    <option value="UTILITY">
                      {language === "hi" ? "उपयोगिता (Utility)" : "Utility"}
                    </option>
                  </select>
                ...
                <div className="flex-1 flex items-center min-w-0 relative">
                  ...
                  <input
                    ...
                    placeholder={
                      language === "hi"
                        ? "निर्देशिका खोजें (उदा. आधार, पैन, लाइसेंस)"
                        : "Search directory (e.g. Aadhaar, PAN, Licence)..."
                    }
                ...
                >
                  {language === "hi" ? "सेवाएं खोजें" : "Search Services"}{" "}
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-6 max-w-3xl mx-auto bg-stone-50 border border-stone-200/65 rounded-2xl p-4 md:p-5 text-center shadow-2xs">
            <div className="space-y-0.5 border-r border-stone-200/60 last:border-0">
              <div className="text-xl md:text-2xl font-black text-brand-coral tracking-tight font-display">
                {copy.stat1_val}
              </div>
              <div className="text-[10px] md:text-xs text-stone-500 font-sans tracking-tight font-medium leading-tight">
                {copy.stat1_lbl}
              </div>
            </div>
            <div className="space-y-0.5 border-r border-stone-200/60 last:border-0">
            ...
            <div className="space-y-0.5 border-r border-stone-200/60 last:border-0">
              <div className="text-xl md:text-2xl font-black text-emerald-600 tracking-tight font-display">
                {copy.stat3_val}
              </div>
              <div className="text-[10px] md:text-xs text-stone-500 font-sans tracking-tight font-medium leading-tight">
                {copy.stat3_lbl}
          ...
          <div className="space-y-4" id="home-categories-block">
            <div className="text-center md:text-left space-y-0.5">
              <span className="text-[10px] font-bold text-brand-coral block tracking-widest uppercase font-mono">
                {copy.catHeader}
              </span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-0.5">
                      <h4 className="font-bold text-xs group-hover:text-stone-950 font-sans">
                        {cat.label}
                      </h4>
          ...
          <div className="space-y-4" id="popular-cards-block">
            <div className="space-y-0.5">
              <span className="text-[10px] font-bold text-brand-coral block tracking-widest uppercase font-mono">
                {language === "hi" ? "आधिकारिक डेटा" : "PORTAL TOP PICKS"}
              </span>
              <h2 className="text-xl font-bold tracking-tight text-stone-900 font-sans">
                {copy.popularHeader}
              </h2>
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between gap-1">
                        <span
                          className={`px-2 py-0.5 rounded text-[9.5px] font-bold font-mono uppercase tracking-wider border ${getCategoryTheme(service.category, service.title)}`}
                        >
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-[10px] font-mono text-stone-400 justify-end">
                          <span
                            className="flex items-center gap-1 bg-rose-50 border border-rose-100/70 text-rose-700 px-1.5 py-0.5 rounded text-[9.5px] font-bold"
                            title="Trending citizen interest metric"
                          >
                            <Sparkles className="w-2.5 h-2.5 text-rose-500 animate-pulse shrink-0" />
                            <span>
                              {popularityScores[service.id] || 0}{" "}
                              {language === "hi" ? "रुचि" : "views"}
                            </span>
                          </span>
                          <span
                            className="flex items-center gap-1 bg-stone-100/60 px-1.5 py-0.5 rounded text-[9.5px] font-semibold"
                            title="Estimated reading time"
                          >
                            <BookOpen className="w-3 h-3 text-stone-400" />
                            <span>
                              {getReadingTime(service)} {language === "hi" ? "मि पठन" : "min read"}
                            </span>
                          </span>
                      ...
                      <div className="space-y-1">
                        <div className="flex flex-wrap items-center gap-1.5">
                          ...
                          <button
                            ...
                            title={
                              language === "hi"
                                ? "त्वरित प्रक्रिया प्रो-टिप देखें"
                                : "View fast-track pro-tip"
                            }
                            id={`popular-pro-tip-btn-${service.id}`}
                          >
                            <Sparkles
                              className={`w-2.5 h-2.5 ${showProTips[service.id] ? "text-neutral-950" : "text-amber-500 animate-pulse"}`}
                            />
                        ...
                        <div className="pt-0.5 pb-1 select-none">
                          <span
                            className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-250/20 text-[#1D4ED8] text-[9.5px] font-bold font-mono shadow-3xs"
                            title="Average Processing Time"
                          >
                            <Clock className="w-3.5 h-3.5 text-blue-500 shrink-0" />
                            <span>
                              {language === "hi"
                                ? `औसत प्रसंस्करण समय: ${service.processingTime}`
                                : `Avg. Processing Time: ${service.processingTime}`}
                            </span>
                          </span>
                        </div>
                        ...
                        >
                          ...
                          <div className="space-y-0.5 text-left">
                            <span className="text-[9px] font-extrabold font-mono uppercase tracking-wider text-amber-700 block">
                              {language === "hi"
                                ? "त्वरित प्रक्रिया प्रो-टिप:"
                                : "Expedite Process Pro-Tip:"}
                            </span>
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-[#111111] select-none">
                              {language === "hi"
                                ? "आवश्यक दस्तावेज़ कार्यपत्र"
                                : "Required Documents List"}
                            </span>
                            <span className="px-1.5 py-0.5 rounded-full bg-stone-200 text-stone-700 text-[9px] font-bold font-mono select-none">
                              {getCheckedCount(service.id, service.documentsRequired)}/
                              {service.documentsRequired.length}
                            </span>
                          </div>
                          <ChevronDown
                            className={`w-3.5 h-3.5 text-stone-400 transition-transform duration-200 shrink-0 ${expandedDocServices[service.id] ? "rotate-180" : ""}`}
                          />
                        </button>

                        {expandedDocServices[service.id] ? (
                          <div
                            className="p-3 bg-brand-cream-card/70 border border-stone-200/40 rounded-xl space-y-2 animate-fadeIn"
                            id={`popular-docs-container-${service.id}`}
                          >
                            <div className="flex items-center justify-between text-[10px] text-stone-500 font-bold uppercase font-mono tracking-wider select-none">
                              <span>
                                {language === "hi"
                                  ? "दस्तावेज़ उपलब्धता चेकलिस्ट"
                                  : "Availability Checklist"}
                              </span>
                              <span className="text-brand-coral">
                                {getPercentReady(service.id, service.documentsRequired)}%
                              </span>
                            </div>
                            ...
                            <div className="w-full h-1.5 bg-stone-200/80 rounded-full overflow-hidden select-none">
                              <div
                                ...
                                style={{
                                  width: `${getPercentReady(service.id, service.documentsRequired)}%`,
                                }}
                              ></div>
                            </div>
                              ...
                              {service.documentsRequired.map((doc, idx) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={`leading-normal ${isChecked ? "text-stone-400 line-through decoration-stone-200/60" : "text-stone-850 font-semibold"}`}
                                    >
                                      {doc}
                                    </span>
                                  </li>
                            ...
                            {getCheckedCount(service.id, service.documentsRequired) ===
                              ...
                              <div className="p-2 bg-emerald-50 text-emerald-800 border border-emerald-150 rounded-lg text-[10px] font-bold flex items-center gap-1.5 mt-1 animate-pulse select-none">
                                ...
                                <span>
                                  {language === "hi"
                                    ? "सभी दस्तावेज़ तैयार हैं! सीधे आवेदन करें।"
                                    : "Excellent! All documents are ready to submit."}
                                </span>
                              </div>
                            )}
                          </div>
                    ...
                    <div className="flex items-center justify-between pt-2.5 border-t border-stone-100">
                      <div className="flex flex-wrap items-center gap-1.5">
                          ...
                          title={
                            toggledTranslates[service.id]
                              ...
                              : language === "hi"
                                ...
                                : `Translate to ${language === "en" ? "Hindi" : "selected language"}`
                          }
                        >
                          <Languages
                            className={`w-3.5 h-3.5 ${toggledTranslates[service.id] ? "text-orange-500" : "text-stone-400"}`}
                          />
                          <span className="text-[10px] font-bold font-sans ml-1">
                            {toggledTranslates[service.id]
                              ? language === "hi"
                        ...
                        >
                          <Bookmark
                            className={`w-3.5 h-3.5 ${savedIds.includes(service.id) ? "fill-amber-500 text-amber-500 font-bold" : "text-stone-400"}`}
                          />
                          <span className="text-[10px] font-bold font-sans ml-1">
                            {savedIds.includes(service.id)
                              ? language === "hi"
                        ...
                        <button
                          ...
                          title={
                            language === "hi"
                              ? "त्रुटि या टूटी लिंक की रिपोर्ट करें"
                              : "Report incorrect info or broken link"
                          }
                        >
                        ...
                        <button
                          ...
                          title={
                            language === "hi" ? "कल्याण अभियान दान" : "Donate & Support Welfare"
                          }
                        >
                        ...
                        <button
                          ...
                          title={
                            language === "hi"
                              ? "आवेदन प्रक्रिया प्रवाह आरेख देखें"
                              : "View application process workflow flowchart"
                          }
                        ...
                        <button
                          ...
                          title={
                            language === "hi"
                              ? "त्वरित आवेदन और इंटरैक्टिव ट्यूटोरियल"
                              : "Interactive guide for instant validation & quick apply steps"
                          }
          ...
          <div className="bg-stone-50 border border-stone-200/70 rounded-2xl p-6 shadow-2xs space-y-6">
            <h3 className="font-display font-extrabold text-sm uppercase tracking-wider text-stone-400 text-center">
              {copy.whyHeader}
            </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-200 pb-4">
            <div className="space-y-1 animate-fade-in">
              ...
              <p className="text-xs text-stone-500">
                {language === "hi"
                  ? "कुल उपलब्ध सरकारी योजनाओं और प्रमाणपत्रों की सूची"
                  : "Full catalog list of verified citizen gateways & e-Sevas"}
              </p>
            </div>
              ...
              <div className="relative inline-flex items-center bg-white border border-[#E5E2D9] rounded-xl pl-3 pr-2 py-1.5 text-[10.5px] font-bold text-stone-650 shadow-2xs hover:border-brand-coral/30 cursor-pointer transition">
                ...
                >
                  <option value="RELEVANCE">
                    {language === "hi" ? "प्रासंगिकता (Default)" : "Relevance"}
                  </option>
                  <option value="POPULARITY">
                    {language === "hi" ? "लोकप्रियता (Trending)" : "Popularity"}
                  </option>
                  <option value="ALPHABETICAL">
                    {language === "hi" ? "वर्णानुक्रम (A-Z)" : "Alphabetical"}
                  </option>
                  <option value="NEWEST">
                    {language === "hi" ? "नवीनतम जोड़े गए" : "Newest Added"}
                  </option>
                </select>
          ...
          <div
            className="bg-[#FAF8F5] border border-stone-200/90 p-3.5 rounded-2xl flex flex-col md:flex-row items-stretch md:items-center gap-3 shadow-3xs"
            id="catalog-filter-dashboard"
          >
            ...
            <div className="relative shrink-0 flex items-center bg-white border border-[#E5E2D9] rounded-xl px-3.5 py-2 hover:border-brand-coral/30 cursor-pointer shadow-3xs transition">
              ...
              <span className="text-[10px] text-stone-450 uppercase tracking-wider font-mono mr-1.5 hidden lg:inline">
              ...
              >
                <option value="ALL">
                  {language === "hi" ? "सभी श्रेणियां (All)" : "All Categories"}
                </option>
                <option value="POPULAR">
                  {language === "hi" ? "लोकप्रिय (Popular)" : "Popular Services"}
                </option>
                <option value="IDENTITY">
                  {language === "hi" ? "पहचान पत्र (Identity)" : "Identity & Civil"}
                </option>
                <option value="HEALTH">
                  {language === "hi" ? "स्वास्थ्य (Health)" : "Health & Medical"}
                </option>
                <option value="AGRICULTURE">
                  {language === "hi" ? "कृषि एवं किसान (Agriculture)" : "Agriculture & Farming"}
                </option>
                <option value="FINANCE">
                  {language === "hi" ? "वित्त एवं कर (Finance)" : "Finance & Tax"}
                </option>
                <option value="EDUCATION">
                  {language === "hi" ? "शिक्षा (Education)" : "Education & Scholarships"}
                </option>
                <option value="WELFARE">
                  {language === "hi" ? "कल्याण योजनाएं (Welfare)" : "Welfare & Social Schemes"}
                </option>
                <option value="LAND">
                  {language === "hi" ? "भूमि एवं संपत्ति (Land)" : "Land & Property"}
                </option>
                <option value="LABOUR">
                  {language === "hi" ? "श्रमिक एवं परिवहन (Labour)" : "Labour & Transport"}
                </option>
                <option value="SAVED">
                  {language === "hi" ? "सहेजी गई सेवाएं (Saved)" : "Saved Services"}
                </option>
            ...
            <div className="relative flex-1 flex items-center bg-white border border-[#E5E2D9] rounded-xl shadow-3xs focus-within:border-brand-coral/60 focus-within:ring-2 focus-within:ring-brand-coral/5 transition">
              ...
              <input
                ...
                placeholder={
                  activeCategory !== "ALL"
                    ? language === "hi"
                      ? `श्रेणी में खोजें (${activeCategoryName})...`
                      : `Search within ${activeCategoryName}...`
                    : language === "hi"
                      ? "त्वरित कीवर्ड फ़िल्टर (उदा. आधार, राशन)..."
                      : "Instant keyword filter (e.g. Aadhaar, Ration)..."
                }
                value={standaloneKeyword}
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none">
            {categories.map((cat) => {
              ...
              const labelClean =
                cat.id === "ALL" && language === "hi" ? "सभी" : cat.label.split(" (")[0];
              return (
                <button
                  key={cat.id}
                  onClick={() => handleCategoryClick(cat.id)}
          ...
          {activeCategory !== "ALL" && (
            <div
              className="bg-gradient-to-r from-orange-50/90 via-white to-amber-50/60 border border-orange-200/90 p-4 rounded-2xl shadow-3xs space-y-3 font-sans animate-fade-in"
              id="active-category-search-banner"
            >
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-xs font-mono font-bold text-stone-500">
                        ...
                        {language === "hi" ? "सेवाएं मिलीं" : "services found"})
                      </span>
                    </div>
                    <h3 className="text-sm sm:text-base font-black text-stone-900 font-display mt-0.5">
                      {language === "hi"
                        ? `${activeCategoryName} में खोजें`
                        : `Searching in ${activeCategoryName}`}
                    </h3>
                  </div>
                </div>
              ...
              {CATEGORY_SEARCH_TAGS[activeCategory] && (
                <div className="flex flex-wrap items-center gap-1.5 pt-0.5">
                  ...
                  {CATEGORY_SEARCH_TAGS[activeCategory][language === "hi" ? "hi" : "en"].map(
                    (tag) => {
          ...
          {filteredServices.length === 0 ? (
            <div className="p-16 text-center border-2 border-dashed border-stone-200 bg-[#FAF8F5] rounded-3xl space-y-3">
              <p className="font-bold text-stone-850 text-xs">
                {language === "hi"
                  ? "कोई भी मेल खाने वाली सेवा मयस्सर नहीं है"
                  : "No matching directory services"}
              </p>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex items-start justify-between gap-1.5 flex-wrap">
                                  ...
                                  <div className="flex flex-wrap items-center gap-2 text-[10px] text-stone-450 font-mono justify-end font-sans">
                                    ...
                                    >
                                      <BookOpen className="w-3 h-3 text-stone-400" />
                                      <span>
                                        {getReadingTime(service)}{" "}
                                        {language === "hi" ? "मि पठन" : "min read"}
                                      </span>
                                    </span>
                                    <div className="flex items-center gap-1">
                                      <Clock className="w-3.5 h-3.5" /> {service.processingTime}
                                  ...
                                  <div className="flex flex-wrap items-center gap-1.5">
                                    ...
                                    {completedTutorials[service.id] && (
                                      <span className="flex items-center gap-0.5 text-[9px] font-bold font-mono text-emerald-700 bg-emerald-50 border border-emerald-250 px-1.5 py-0.5 rounded-full select-none shadow-3xs animate-fadeIn">
                                        <CheckCircle className="w-2.5 h-2.5 text-emerald-500" />
                                        <span>
                                          {language === "hi" ? "त्वरित गाइड पूर्ण" : "Guide Done"}
                                        </span>
                                      </span>
                                    )}
                                    <button
                                ...
                                <div className="space-y-2">
                                  ...
                                  {expandedDocServices[service.id] ? (
                                    <div
                                      className="p-3 bg-brand-cream-card/70 border border-stone-200/40 rounded-xl space-y-2 animate-fadeIn"
                                      id={`catalog-docs-container-${service.id}`}
                                    >
                                      <div className="flex items-center justify-between text-[10px] text-stone-500 font-bold uppercase font-mono tracking-wider select-none">
                                        <span>
                                          {language === "hi"
                              ...
                              <div className="pt-3 border-t border-stone-100 flex items-center justify-between gap-4">
                                <div className="flex flex-wrap items-center gap-2.5">
                                  <button
                                    ...
                                    title={
                                      language === "hi" ? "साझा करें" : "Share Service Details"
                                    }
                                  >
                                    {copiedServiceId === service.id ? (
                                  ...
                                  >
                                    <Languages
                                      className={`w-4.5 h-4.5 ${toggledTranslates[service.id] ? "text-orange-500 font-bold" : "text-stone-400"}`}
                                    />
                                    <span className="text-[10px] font-bold font-sans ml-1">
                                      {toggledTranslates[service.id]
                                        ? language === "hi"
                                  ...
                                  >
                                    <Bookmark
                                      className={`w-4 h-4 ${savedIds.includes(service.id) ? "fill-amber-500 text-amber-500" : "text-stone-400"}`}
                                    />
                                    <span className="text-[10px] font-bold font-sans ml-1">
                                      {savedIds.includes(service.id)
                                        ? language === "hi"
                                  ...
                                  <div className="font-mono text-xs">
                                    <span className="text-stone-450 text-[10.5px] block leading-none">
                                      {language === "hi" ? "आधिकारिक शुल्क" : "Official Govt Fee"}
                                    </span>
                                ...
                                >
                                  {language === "hi" ? "मार्गदर्शिका और दस्तावेज़" : "Guide & Docs"}{" "}
                                  <ArrowRight className="w-3.5 h-3.5" />
                                </button>
                              </div>
                            </motion.div>
            ...
            <div className="text-[11.5px] text-stone-700 leading-relaxed font-sans">
              <strong>
                {language === "hi"
                  ...
                  : "💡 Pro Tip for Indian Citizens:"}
              </strong>{" "}
              {t("directory.pro_tip_desc")}
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="p-6 md:p-8 pb-4 border-b border-stone-200/60 flex items-start justify-between gap-4">
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-2 py-0.5 rounded text-[9.5px] font-bold font-mono uppercase tracking-wider border ${getCategoryTheme(selectedWorkflowService.category, selectedWorkflowService.title)}`}
                          >
                          ...
                          <span className="flex items-center gap-1 text-[10px] font-mono text-emerald-600 font-bold bg-emerald-50 px-2 py-0.5 rounded-full select-none">
                            ...
                            <span>
                              {language === "hi" ? "त्वरित मार्गदर्शन" : "Interactive Guide"}
                            </span>
                          </span>
                        </div>
                    ...
                    <div className="p-6 md:p-8 pt-4 pb-6 space-y-6 overflow-y-auto max-h-[60vh] scrollbar-thin">
                      ...
                      <div className="p-4 rounded-2xl bg-white border border-stone-200/50 shadow-3xs space-y-3">
                        <div className="flex items-center justify-between text-xs font-bold text-stone-800 font-sans select-none">
                          <span>
                            {language === "hi"
                              ? "आवेदन प्रगति स्तर"
                              : "Application Setup Steps Progress"}
                          </span>
                          <span className="text-emerald-700 font-mono text-[11px] font-bold">
                            {completedCount}/{totalSteps}{" "}
                            {language === "hi" ? "पूर्ण" : "Completed"} ({percentCompleted}%)
                          </span>
                        </div>
                      ...
                      <div className="relative pl-4 space-y-6" id="workflow-flowchart-stepper">
                        ...
                        {steps.map((step) => {
                          ...
                          const stepDuration =
                            language === "hi" ? step.durationHi : step.durationEn;
                          ...
                          return (
                            ...
                            >
                              ...
                              <button
                                type="button"
                                onClick={() =>
                                  handleToggleWorkflowStep(selectedWorkflowService.id, step.id)
                                }
                              ...
                              >
                                <div className="flex flex-wrap items-center justify-between gap-2 mb-1.5">
                                  <h4
                                    className={`text-xs font-extrabold leading-tight ${isStepChecked ? "text-emerald-950 line-through decoration-emerald-200/60" : "text-[#111111]"}`}
                                  >
                                    {step.id}. {stepTitle}
                                  </h4>
                                  <span
                                    className={`flex items-center gap-1 text-[9px] font-bold font-mono tracking-tight uppercase px-1.5 py-0.5 rounded ${
                                      isStepChecked
                                ...
                                <p
                                  className={`text-[11px] leading-relaxed ${isStepChecked ? "text-emerald-900/75" : "text-stone-605"}`}
                                >
                                  {stepDesc}
                                </p>
                                ...
                                <div className="flex items-center justify-end mt-2 select-none">
                                  <span
                                    className={`text-[9.5px] font-bold font-mono uppercase tracking-wider ${isStepChecked ? "text-emerald-700" : "text-stone-400 group-hover:text-emerald-600 transition"}`}
                                  >
                                    {isStepChecked
                                      ? language === "hi"
                                        ? "✓ पूर्ण सहेजा"
                        ...
                        <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-150 flex items-start gap-3 shadow-2xs animate-pulse">
                          ...
                          <div className="space-y-0.5">
                            <h5 className="font-extrabold text-emerald-900 text-xs">
                              {language === "hi"
                                ? "बधाई हो! सारी प्रक्रिया पूरी हो चुकी है।"
                                : "Congratulations! All process milestones completed."}
                            </h5>
                  ...
                  >
                    ...
                    <div className="p-5 md:p-6 pb-3 border-b border-stone-200/60 flex items-start justify-between gap-4">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-2 py-0.5 rounded text-[9.5px] font-bold font-mono uppercase tracking-wider border ${getCategoryTheme(selectedQuickApplyService.category, selectedQuickApplyService.title)}`}
                          >
                        ...
                        <h3 className="font-display font-black text-slate-950 text-base md:text-lg leading-tight">
                          {selectedQuickApplyService.title} —{" "}
                          {language === "hi" ? "त्वरित आवेदन गाइड" : "Quick Apply Tutorial"}
                        </h3>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-1.5 select-none">
                            <span className="px-2 py-0.5 rounded bg-amber-50 border border-amber-200/60 font-mono text-[9px] font-extrabold text-amber-700 tracking-wider uppercase">
                              {language === "hi"
                                ? `चरण ${quickApplyStep + 1}`
                                : `Step ${quickApplyStep + 1}`}
                            </span>
                          ...
                          <div className="p-4 rounded-2xl bg-white border border-stone-200/60 shadow-3xs space-y-2.5">
                            <h5 className="text-[11px] font-extrabold text-[#111111] uppercase tracking-wide flex items-center gap-1">
                              ...
                              <span>
                                {language === "hi"
                                  ? currentStepData.checklistLabelHi
                                  : currentStepData.checklistLabelEn}
                              </span>
                            </h5>
                            <div className="space-y-2">
                              {(language === "hi"
                                ? currentStepData.checklistHi
                                : currentStepData.checklistEn
                        ...
                        <div className="p-3.5 rounded-xl bg-amber-50/50 border border-amber-150 flex items-start gap-2.5 text-left">
                          ...
                          <div className="space-y-0.5">
                            ...
                            <p className="text-[11px] text-amber-900 leading-normal font-sans">
                              {language === "hi"
                                ? currentStepData.proTipHi
                                : currentStepData.proTipEn}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="md:col-span-5 flex flex-col justify-center items-center">
                        <div className="w-full max-w-sm rounded-2xl border border-stone-200 bg-white p-5 shadow-xs relative overflow-hidden flex flex-col min-h-[300px] justify-between">
                                ...
                                case 1:
                                  return (
                                    <div className="space-y-3 flex flex-col items-center animate-scale">
                                      ...
                                      <div
                                        className="border border-stone-150 rounded-lg p-2 bg-stone-50/80 w-44 text-left font-mono text-[8px] text-stone-5
                                    00 space-y-1"
                                      >
                          ...
                          <div className="p-2 border-t border-stone-100 bg-stone-50/70 rounded-xl text-center select-none text-[10.5px] font-serif italic text-stone-555">
                            &ldquo;
                            {language === "hi"
                              ? currentStepData.visualActionHi
                              : currentStepData.visualActionEn}
                            &rdquo;
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="p-5 md:p-6 bg-stone-50 border-t border-stone-200 flex items-center justify-between gap-3 rounded-b-3xl">
                      ...
                      <div className="hidden sm:block text-[11px] font-bold font-mono text-stone-400">
                        {language === "hi" ? "चरण प्रगति" : "Walkthrough Progress"}:{" "}
                        {Math.round(((quickApplyStep + 1) / totalSteps) * 100)}%
                      </div>
                      ...
                      {isLastStep ? (
                        ...
                        >
                          {language === "hi"
                            ? "समाप्त और अधिकारिक पोर्टल पर जाएं"
                            : "Finish & Proceed to Portal"}{" "}
                        ...
                        >
                          {language === "hi" ? "आगे बढ़ें" : "Next Milestone"}{" "}
                          <ArrowRight className="w-4 h-4" />
                        </button>
                      )}
                    </div>
